...
export function MalfunctionPopup({ malfunctionPopup, setMalfunctionPopup, soundEnabled = true }) {
  useEffect(() => {
    if (malfunctionPopup) playHallPassSound('alert', soundEnabled);
  }, [soundEnabled, malfunctionPopup?.tier, malfunctionPopup?.deviceLabel]);
