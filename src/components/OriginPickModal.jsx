...
export function OriginPickModal({ student, onPick, soundEnabled = true, week = 1 }) {
  ...
  return (
    <ModalOverlay dismissible={false} soundEnabled={soundEnabled} style={{ zIndex: 470 }}>
      <div className="hall-pass-modal-in origin-pick-modal" role="dialog" aria-modal="true" aria-labelledby="origin-title" style={{ ...C.modal, maxWidth: 680, background: 'linear-gradient(160deg,#080412,#140920,#080412)' }}>
