...
import {
  renderWeighInIntro,
  renderWeighInReaction,
  renderWeighInBreak,
  renderWeighInSwap,
  renderWeighInPurchase,
...
export function WeighInModal({weighInState,setWeighInState,bigScaleUnlocked,brokeScaleIds,onBreakScale,onUnlockBigScale,week,campusFattening=false,campusTier=0}){
  ...
  const onBigScale=goesDirectlyToBig||phase==="digital";
  const weighInOpts = {
  ...
  return(
    <div style={C.overlay}>
      <div style={{...C.modal,maxWidth:560}}>
        ...
        {phase==="break"&&(
          <>
            <div style={{...C.infoBox("rgba(60,5,15,.5)"),border:"1px solid #80202040",fontSize:13,color:"#f0c0a0",lineHeight:1.85,fontStyle:"italic",marginBottom:14}}>{renderWeighInBreak(student,week||1,weighInOpts)}</div>
        ...
        {phase==="purchase"&&(
          <>
            <div style={{...C.infoBox("rgba(40,20,60,.45)"),border:"1px solid #5028a040",fontSize:13,color:"#e0d0b0",lineHeight:1.85,fontStyle:"italic",marginBottom:14}}>{renderWeighInPurchase(student,week||1,weighInOpts)}</div>
        ...
        {phase==="swap"&&(
          <>
            <div style={{...C.infoBox("rgba(35,40,55,.55)"),border:"1px solid #6a708040",fontSize:13,color:"#d0d8e0",lineHeight:1.85,fontStyle:"italic",marginBottom:14}}>{renderWeighInSwap(student,week||1,weighInOpts)}</div>
