...
export {
  DEPTH_TALK_TOPICS,
  talkTopicAvailable,
  applyTalkHabitatBonus,
  hiveShiftFx,
  leftoverNightGainBump,
  depthGainLbs,
  homeroomArcFx,
  wifeRepeatFx,
  contestBiteLbs,
  ...
  tickHabitatWeek,
  habitatFx,
  shouldSkipHungerInterrupt,
  neighborEcologyPatch,
  campusStayHome,
  pantryDropBonus,
  sessionCapHabitatBonus,
  deviceTickHabitatMult,
  oppositionRumorChance,
  labInstabilityEase,
  digestStuffedExtras,
  tickOutfitWeek,
} from './habitatDepth.js';
