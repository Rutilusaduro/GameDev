export const STAGE_REACTIONS = {
  ...
  farm_girl: [
    (s)=>`Mary Jane laughs at the scale like it told a bad joke. ${Math.round(s.lbs)} pounds is skinny for a girl who grew up on sweet potato pie. She tucks the reading into her jam journal and writes "fix this" beside it.`,
    ...
    (s)=>`Mary Jane barely leaves her corner now, and the hall wouldn't let her if she tried. She is ${Math.round(s.lbs)} pounds and enormous and warm, the girl with jam for every mood and pie for every crisis. "Sit down, sugar," she says. "I already cut you a slice."`,
  ],
};
