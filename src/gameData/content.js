export const STAGE_REACTIONS = {
  ...
  bookworm: [
    (s) => `The scale reads ${Math.round(s.lbs)} pounds and I can feel my ribs clearly through my shirt. I've logged it in my hall log journal and added a corrective dietary schedule. The data is not good but the data is correctable.`,
    (s) => `I've been eating through study sessions — snacks between chapters, second helpings at dinner — and the results at ${Math.round(s.lbs)} pounds are already showing. My jeans are tighter through the hips. I feel better. The hall log continues.`,
    ...
    (s) => `My hall log now includes detailed notes on the physical experience of weighing ${Math.round(s.lbs)} pounds. My belly rounds forward against the desk and I can feel exactly how warm and heavy it is. My thighs spread wide in the chair. Nothing with buttons closes across my belly anymore. I've ordered larger clothes. My floor output is unaffected. Both things are good.`,
    (s) => `I tracked everything: at ${Math.round(s.lbs)} pounds, my belly hangs forward visibly when I stand, my thighs press together from hip to knee, my chest rests heavily on top of my belly when I lean over my books. I had to ask the library to reinforce my study carrel. They did it without comment. I've logged the interaction. The season plan is progressing and so is everything else.`,
    (s) => `A folding chair collapsed under me at the hall panel review last Thursday. I finished writing my note before addressing the situation. My belly is a substantial, warm, round presence at ${Math.round(s.lbs)} pounds — it hangs past my hips and fills my lap entirely. My thighs are wide and pressed together. I have begun working from my room three days a week. The correlation between comfort and productivity is documented and positive.`,
    (s) => `I've filed two hall logs this semester and I weigh ${Math.round(s.lbs)} pounds and these facts are related in the way that all good data is related: they reinforce each other. My desk has been modified to accommodate my belly, which rounds forward enormously and is warm and heavy and mine. My thighs spread the full width of the custom chair. I order delivery for every meal. I am the most productive I have ever been.`,
    (s) => `The data at ${Math.round(s.lbs)} pounds is extraordinary and I have documented all of it. My belly is vast and warm — it fills my entire lap and presses against the edge of the reinforced desk. My thighs are enormous and soft. I haven't worn fitted clothing in over a year. I study from bed now, propped up with purpose-built supports, eating while I read. My hall log has never been better. My body has never been better. The correlation is noted.`,
    (s) => `Every step is deliberate and every chair is assessed before I commit my ${Math.round(s.lbs)} pounds to it. My belly is an enormous, warm, heavy presence that fills my lap and rounds forward impressively. I work from bed entirely now. Books are arranged on a custom lectern so I can read without straining forward. I eat through every study session. My season plan is due in spring and it will be excellent. Everything I am pursuing is going perfectly.`,
    (s) => `My hall log spans four volumes now and my body weighs ${Math.round(s.lbs)} pounds and both of these things are correct outcomes of a process I have been conducting with great care. My belly fills my lap entirely and presses warm and heavy against my thighs. I am immense and brilliant and the two things are not in conflict — the data has proven this repeatedly. I want to be bigger. I've added that to the season plan objectives.`,
    (s) => `I have filed and I am vast and I do not leave my room but everything comes to me. At ${Math.round(s.lbs)} pounds I am the primary data point in the most interesting hall log I have ever kept. My belly fills my lap and spills past it. My thighs are wide and enormous and warm. I eat while I write and I write about eating and the loop is closed and perfect. I am exactly what the hall log predicted I would become.`,
  ],
  influencer: [
    ...
    (s) => `My followers watch me eat every single day and they watched the scale hit ${Math.round(s.lbs)} pounds live and the comments were incredible. My belly fills out every shirt I own and hangs forward and I film it. My thighs spread wide on the couch and I film that. My face is round and soft and I film that too. I want to be the biggest creator in my category. I want the whole floor to see exactly what I look like.`,
    ...
    (s) => `I am ${Math.round(s.lbs)} pounds and one of the most-watched feedee creators online and my belly fills half the frame of the camera now — my team had to reframe the shot. My thighs are wide and warm. I want residents to come see me in person so they understand what's possible. Everything I've built has been about getting here and getting bigger.`,
    ...
    (s) => `I am ${Math.round(s.lbs)} pounds and a household name in three countries because of this body and this camera. My belly is a monument. My thighs are columns. I eat on camera every day and the world watches and loves it and I love it back. The floor knows my face. They know my belly. They know this number. This is what I was built for.`,
  ],
  athlete: [
  ...
  artsy: [
    ...
    (s) => `The gallery comes to me now. I work from where I sit — from my studio, from my bed, from my enormous custom chair — and at ${Math.round(s.lbs)} pounds my belly is vast and warm and fills my lap entirely. My thighs are wide and heavy. I am the most interesting model I have ever had and I keep getting more interesting. Everything I make is about this body and how much more I want of it.`,
    ...
    (s) => `They will write about me. They are already writing about me. At ${Math.round(s.lbs)} pounds I paint from bed and the paintings are about exactly this — the weight, the warmth, the softness, the magnificent enormity of being this body in this room in this life. My belly fills the chair and spills past it. My thighs are enormous and warm. I am the artist and the model and the work and all three are at maximum. This is the piece. This is the whole piece.`,
  ],
  ...
  quiet: [
    ...
    // Stage 6 ~285-360 lbs
    (s) => `She fills the room now even when she says nothing. At ${Math.round(s.lbs)} pounds her belly is vast and warm and her thighs spread the full width of the chair. She watches residents eating and her expression is precise and satisfied and private. She stopped sitting in any particular spot — she takes the center of wherever she is.`,
    // Stage 7 ~360-465 lbs
  ...
  psych: [
    ...
    // Stage 7 ~360-465 lbs
    (s) => `${Math.round(s.lbs)} lbs. I've stopped trying to note this neutrally. It isn't neutral anymore — it's real and heavy and warm and mine. My hall log has benefited. I can observe from the inside in ways I couldn't have imagined at ${Math.round(s.startLbs)} pounds. My notes from this phase will make good reading.`,
    // Stage 8 ~465-595 lbs
  ...
  culinary: [
    ...
    (s)=>`She waves you toward the lounge table with a tray of warm rolls and a proud, flour-smudged smile. At ${Math.round(s.lbs)} pounds she's still quick on her feet, but her apron already fits like it belongs to someone who tastes everything twice.`,
    (s)=>`Renee looks up from a mixing bowl and grins — ${Math.round(s.lbs)} pounds in soft lounge clothes, round and warm in exactly the way a woman who lives in the kitchen tends to get. "I brought extra," she says. She always brings extra.`,
    (s)=>`Something has shifted in how she moves: slower, more deliberate, pleased. Renee is ${Math.round(s.lbs)} pounds now, her belly soft against the counter edge, and she seems wholly unbothered. She offers you banana bread still warm from the pan. "I've been making a lot of banana bread," she says. You believe it.`,
    (s)=>`She's in her wide apron when you find her, the ties cinched at the back but the front bowing out comfortably. ${Math.round(s.lbs)} pounds and she carries herself like someone who has made peace with her size. "I started keeping tasting notes," she says, patting the notebook in her apron pocket.`,
    (s)=>`Renee fills the doorway warmly. She's ${Math.round(s.lbs)} pounds in loose practical layers — soft fabrics chosen after everything else got too tight. Two containers in her hands. "Floor tasting night," she says. There's plenty.`,
    (s)=>`She's at the counter when you arrive, enormous and warm, her belly rounding against the edge as she stirs. ${Math.round(s.lbs)} pounds and her movement through the kitchen is slow and practiced. "I made too much," she says. She always makes too much.`,
    (s)=>`Renee sits at the wide chair she's claimed, her belly filling her lap soft and warm. ${Math.round(s.lbs)} pounds and her arms are round and capable, lifting a mixing bowl with long practice. "I need you to taste the frosting," she says. "It's for Tuesday."`,
    (s)=>`She's enormous now — ${Math.round(s.lbs)} pounds of warm, settled, purposeful woman, her body taking up most of the kitchen corner she's claimed. The apron is decorative at this point but she wears it anyway. "Cinnamon rolls," she says without looking up. She's made twelve. They're large.`,
    (s)=>`Moving takes planning now, but Renee approaches it methodically. She is ${Math.round(s.lbs)} pounds and her setup has grown around her — lowered counter, wide chair within reach. She smiles when she sees you. "You're right on time," she says. "It just came out."`,
    (s)=>`Renee barely moves from her spot now, but she doesn't need to. Everything comes to her — deliveries, residents, moms who stop by with requests. She is ${Math.round(s.lbs)} pounds and enormous and warm, settled into her space like it was built for her. "Sit down," she says. "I've got things for you to try."`,
  ],
  eced:[
  ...
  nursing: [
    (s)=>`Kaylee checks the scale twice, then writes the number in her planner with the same care she gives vitals. ${Math.round(s.lbs)} pounds feels too light on her frame. She adds "extra snacks" to tomorrow's column.`,
    (s)=>`She meets you in the lounge with a thermos of soup and that attentive look that makes everyone feel looked after. At ${Math.round(s.lbs)} pounds she's still slender, but her scrubs already pull a little across her hips when she bends to set the tray down.`,
    (s)=>`Kaylee smiles when she sees you — ${Math.round(s.lbs)} pounds in a soft hoodie and leggings, warm and approachable in the way someone who feeds everyone else tends to become. "I brought enough for two," she says. She brought enough for six.`,
    (s)=>`Her walk has slowed to something more deliberate, more comfortable. Kaylee is ${Math.round(s.lbs)} pounds now, her belly soft beneath her cardigan, and she doesn't seem bothered at all. She offers you mac and cheese from a big casserole dish. "Stress week special," she says.`,
    (s)=>`She's in stretch scrubs when you find her, the fabric forgiving where her body has rounded. ${Math.round(s.lbs)} pounds and she moves like someone who has stopped apologizing for taking up space. "I keep a snack drawer now," she admits. "For me. Finally."`,
    (s)=>`Kaylee fills a lounge chair warmly. She's ${Math.round(s.lbs)} pounds in soft wide layers, everything chosen for comfort over vanity. Two foil-wrapped plates in her lap. "I made too much again," she says, pleased.`,
    (s)=>`She's settled at the big table when you arrive, enormous and warm, her belly rounding comfortably against the edge. ${Math.round(s.lbs)} pounds and she navigates the hall with practiced ease. "Sit," she says. "You look like you need feeding."`,
    (s)=>`Kaylee sits in the wide chair she's claimed, her belly filling her lap soft and heavy. ${Math.round(s.lbs)} pounds and her arms are round and capable, lifting a casserole dish like it's nothing. "I need a second opinion on the pot roast," she says.`,
    (s)=>`She's enormous now — ${Math.round(s.lbs)} pounds of warm, settled caregiver, her body taking up the whole end of the common room couch. "I ordered custom scrubs," she says cheerfully. "They fit. That's new."`,
    (s)=>`Moving takes planning, but Kaylee handles it with calm practicality. She is ${Math.round(s.lbs)} pounds and her corner of the lounge has been rearranged around her — wide chair, side table within reach, blanket always ready. "You're just in time," she says. "Dinner's hot."`,
    (s)=>`Kaylee barely leaves her spot now, and the floor has learned to come to her. She is ${Math.round(s.lbs)} pounds and enormous and warm, the person everyone sits near when they need comfort and food. "Sit down," she says. "I've got you."`,
  ],
  farm_girl: [
    (s)=>`Mary Jane laughs at the scale like it told a bad joke. ${Math.round(s.lbs)} pounds is skinny for someone who grew up on sweet potato pie. She tucks the reading into her jam journal and writes "fix this" beside it.`,
    (s)=>`She waves you over from the lounge with a mason jar of peach preserves and a grin that could warm the whole hall. At ${Math.round(s.lbs)} pounds she's still light on her feet, but her sundress already hugs her chest and hips like summer's been good to her.`,
    (s)=>`Mary Jane looks up from a pie tin and beams — ${Math.round(s.lbs)} pounds in a soft gingham dress, round and sunny in exactly the way a farm girl with six kinds of jam tends to get. "I brought backup dessert," she says. Always does.`,
    (s)=>`Something has softened in how she settles into chairs — slower, happier, more planted. Mary Jane is ${Math.round(s.lbs)} pounds now, her belly warm against her apron strings, and she looks pleased as sunshine. "Made sweet potato pie," she says. "For science."`,
    (s)=>`She's in overalls over a stretchy tee when you find her, the straps adjusted for comfort. ${Math.round(s.lbs)} pounds and she carries herself like someone who's stopped fighting her curves. "Mama'd call this thriving," she says, patting her hip.`,
    (s)=>`Mary Jane fills the doorway with warmth. She's ${Math.round(s.lbs)} pounds in soft wide layers, everything loose and practical and still somehow flattering. Two pie boxes in her arms. "Floor social," she says. "Don't be shy."`,
    (s)=>`She's at the common-room table when you arrive, enormous and glowing, her belly rounding against the wood as she cuts another slice. ${Math.round(s.lbs)} pounds and she moves like someone who knows exactly where every chair creaks. "Sit," she says. "Pie first."`,
    (s)=>`Mary Jane sits in the wide rocker she's claimed, her belly filling her lap soft and warm. ${Math.round(s.lbs)} pounds and her arms are round and strong from hauling jam crates. "Need a taste tester," she says. "It's blackberry season."`,
    (s)=>`She's enormous now — ${Math.round(s.lbs)} pounds of warm southern abundance, her body taking up most of the lounge's best corner. "Custom sundresses," she says proudly. "Local seamstress. Worth every penny."`,
    (s)=>`Moving takes planning, but Mary Jane treats it like another farm chore — steady, unhurried, done right. She is ${Math.round(s.lbs)} pounds and her setup has grown around her: wide rocker, side table for pie, fans on request. "You're just in time," she says.`,
    (s)=>`Mary Jane barely leaves her corner now, and the hall wouldn't let her if she tried. She is ${Math.round(s.lbs)} pounds and enormous and warm, the resident with jam for every mood and pie for every crisis. "Sit down, sugar," she says. "I already cut you a slice."`,
  ],
};
...
export const STAGE_DROP_REACTIONS = {
  ...
  bookworm:["Underweight now per the literature. I've revised my dietary schedule. This is correctable.","Lower weight this week. I've noted it. I have a corrective plan.","Down a stage. The data is moving the wrong direction. Addressing it.","Lost some. My chair feels different. I've added to my meal log accordingly.","Dropped. I had good research momentum at that size. This disrupts the hall log.","Lost a significant amount. I was tracking good data at that weight. The trend reversal is unwelcome.","A whole stage down. I was just getting comfortable studying at that size. Reset.","Significant loss. I'd built my whole routine around that body. Recalibrating.","That's a lot of mass gone. I was most productive there. The correlation is documented.","Down from something I was genuinely invested in. My notes from that stage are extensive.","Even from here the absence is notable. I had built something at that scale. Getting it back."],
  swimmer:["Underweight for the training block. I've revised my meal plan. Correctable.","Lower weight this week. Logged it. I have a corrective protocol.","Down a stage. The trend line is wrong. Addressing it.","Lost some. My warmup jacket fits different. Added to the meal log.","Dropped. I had good momentum at that size. Disrupts the season plan.","Lost a significant amount. I was tracking strong splits at that weight. Unwelcome reversal.","A whole stage down. I was settling into that body. Reset.","Significant loss. I'd built my routine around that size. Recalibrating.","That's a lot of mass gone. I was fastest there. The data is documented.","Down from something I was invested in. My logs from that stage are extensive.","Even from here the absence is notable. I had built something at that scale. Getting it back."],
  ...
  overachiever:["Underweight. Failing metric. Corrective meal plan active immediately. I don't fail metrics.","Down on the scale. Noted. Unacceptable. Course correction begins today.","Lost a stage. I had optimized everything around that weight. Regression logged.","Dropped. My productivity was peaking at the higher weight. The data supports this.","Lost a real amount. My season plan literally argued for maintaining that stage. Awkward.","Significant loss. I was achieving peak efficiency at that size. This is a setback.","A whole stage gone. My entire schedule was calibrated for that body.","Lost a lot. I had the most productive semester of my life at that weight.","Down from peak performance. I'm documenting everything and correcting immediately.","That was my best stage in every measurable category. The loss is fully documented.","Even from here, the variance is unacceptable. Getting back to target."],
  ...
  culinary:['"The scale is wrong." She frowns at it, wipes flour off her hands. "I\'m recalibrating dinner."','Lost a bit. My apron hangs looser. She eyes the pantry. "That won\'t last."','Down a size. I don\'t love it. She opens her notebook. "Corrective tasting session tonight."','Dropped. I was getting good flavor from that body. She folds her arms. "Back on track."','Lost a real amount. I liked that fullness in the kitchen. She taps her spoon. "We\'ll fix this."','Significant drop. Less of me to lean on the counter. She looks offended. "Unacceptable."','A whole stage gone. I was cooking from that body. She starts making a list. "Emergency baking."','Lost a lot. That weight had balance. She pats her belly. "Time to rebalance."','Down from my best kitchen self. She shakes her head. "I was happiest there."','That much gone and I felt it in every bite. She cracks her knuckles. "Recovery menu starts now."','Even from here, less feels like bad seasoning. She smiles tightly. "I\'ll earn it back."'],
  ...
  nursing:['"Oh." She tilts her head. "That\'s less than I expected. I\'ll adjust my portions."','Lower today. She writes it in her planner like vitals. "Noted. Corrective snacks incoming."','Down a stage. She touches her hip. "I was comfortable there. Comfortable is good."','Lost some. Her voice goes soft. "I liked feeling that settled. I\'ll get there again."','Dropped. She exhales. "I take care of everyone else. I can take care of this too."','Significant loss. She looks determined, not upset. "Warm meal tonight. Several warm meals."','A whole stage gone. She hugs herself. "I was warmest at that size. I remember."','Lost a lot. She smiles gently. "My hoodie fit differently then. I liked differently."','Down from where I felt most myself. She nods once. "Back on the chart."','That much gone and I noticed in my bones. She laughs quietly. "Okay. Feeding schedule updated."','Even from here I know what plenty felt like. Her eyes brighten. "Plenty is where I\'m headed."'],
...
export const OUTFITS = {
  ...
  bookworm:[
    ...
    "Custom-ordered wide formal robes aesthetic. Dignified.",
  ...
  swimmer:[
    "Team hoodie hangs off narrow shoulders. Warmup pants need a drawstring. Very lean.",
    "Team hoodie, dry-fit leggings, flip-flops from the pool deck.",
    "Hoodie straining across the shoulders. Looser joggers today.",
    "Oversized team jacket open, leggings replacing the suit entirely.",
    "Big fleece layers. Still carries the training log.",
    "Stretchy everything. Still logs splits though.",
    "Wide-fit team sweats and a massive parka.",
    "Custom-ordered wide athletic gear. Still has the swim cap.",
    "Enormous hoodies. A soft, lane-log-holding mountain.",
    "Bespoke wide-fit everything. Cap still damp.",
    "Draped in fabric. Serene. Vast.",
  ],
  influencer:[
  ...
  psych:[
    ...
    "Wide-cut hall-formal wear. Soft structured blazer, loose trousers. The professional silhouette softening.",
    "Custom stretch-fabric professional sets. Hall cardigan over everything — it hides things, which she notes as a variable.",
    "Wide professional layers. Hall cardigans in larger sizes. Everything functional and roomy.",
    "Reinforced stretch professional wear. The blazers are custom now. She has a made-to-measure account.",
    "Wide layered formal wear. Flowing tops, structured wide trousers. She dresses like someone optimised for sitting.",
  ...
  culinary: [
    "Chef's jacket a size too large, apron crisp. Flour ghost on her sleeve.",
    "Fitted apron over a simple tee, lounge pants comfortable for long kitchen sessions.",
    "Wide apron cinched at the back, soft cardigan underneath. Smells like cinnamon.",
    "Flowy tunic over stretch leggings, apron tied at the sides. Practical and warm.",
    "Loose linen trousers and a soft wide-collar top, apron covering the middle completely.",
    "Wide knit top over soft stretch pants. Industrial apron, still not quite enough coverage.",
    "Soft jersey dress with a wide waist, chosen from a brand that finally fits her properly.",
    "Wide-leg soft trousers and a large knit pullover she's stopped tucking in.",
    "Roomy kitchen housedress in a cheerful print — loose enough to reach, tough enough for splatter.",
    "Enormous soft tunic and her best wide-leg pants. Movement deliberate and comfortable.",
    "The apron over everything — symbolic now, but she ties it on every morning. Soft layers beneath, sized for her current reality.",
  ],
  eced:[
  ...
  nursing: [
    "Standard scrubs, slightly loose. Stethoscope in her pocket, hair in a practical ponytail.",
    "Soft scrubs in a warm color, fitted where she's filled out, comfortable where she hasn't yet.",
    "Stretch scrubs and a cardigan for lounge rounds. Pockets full of snacks for residents.",
    "Wide scrubs layered under a soft zip hoodie. Everything chosen for comfort over vanity.",
    "Custom-fit stretch scrubs, cardigan always on. Waistband replaced with something forgiving.",
    "Wide soft scrubs, lounge cardigan, compression socks she jokes about but always wears.",
    "Custom scrubs in her measurements, soft knit top underneath. Warm and approachable.",
    "Wide-format scrubs, oversized cardigan, everything delivered to her door now.",
    "Roomy scrubs-cut loungewear in soft fabrics. She knows her measurements by heart.",
    "Bespoke wide scrubs and a cardigan sized for her current reality. Comfort is the whole brief.",
    "Whatever can be made at her scale — soft layers, wide cuts, warm colors. Always looks ready to feed someone.",
  ],
  farm_girl: [
    "Fitted sundress, denim jacket, boots scuffed from the ag quad. Jam jar in her tote.",
    "Gingham dress with a soft cardigan, boots swapped for sandals. Curves starting to show.",
    "Stretchy sundress under overalls, apron strings tied at the waist. Warm and approachable.",
    "Wide overalls over a soft tee, sundress fabric peeking underneath. Hips filling the straps.",
    "Loose gingham dress, overalls unbuttoned at the sides for comfort. Apron for pie duty.",
    "Wide sundress in a cheerful print, soft cardigan, boots retired for wide sandals.",
    "Custom sundress from a local seamstress, soft and roomy. Overalls hang nearby for chores.",
    "Wide-format sundresses in three colors. Overalls reserved for jam-making days only.",
    "Roomy housedress in farm-print fabric, chosen for kitchen and lounge alike.",
    "Enormous soft sundress, wide cardigan, hair pinned up with a ribbon. Pure southern comfort.",
    "Whatever the local seamstress can make at her measurements — gingham, florals, soft cotton. Always looks like pie weather.",
  ],
  default:[
