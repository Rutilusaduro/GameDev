export const STAGE_REACTIONS = {
  ...
  overachiever: [
    ...
    // Stage 4 ~195-238 lbs
    (s) => `The scale this morning said ${Math.round(s.lbs)} and I entered it into my spreadsheet between my morning reading and my first meal. My belly rounds forward substantially — real, present, warm. My thighs press together. My chest is larger than I planned for and I've updated my wardrobe budget accordingly. My season plan advisor says my output this semester is the strongest she's seen from any student. Both projects are performing.`,
    // Stage 5 ~238-285 lbs
