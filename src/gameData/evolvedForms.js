...
export const FEEDER_SUBJECT_JOURNALS = {
  ...
  psych:[
    ...
    `[placeholder: psych subject journal — body type: voluptuous — Slim stage, entry 2]`,
    `[placeholder: psych subject journal — body type: voluptuous — Soft stage, entry 3]`,
    `[placeholder: psych subject journal — body type: voluptuous — Chubby stage, entry 4]`,
    `[placeholder: psych subject journal — body type: voluptuous — Plump stage, entry 5]`,
