...
export const WL_LESSONS = {
  ...
  2: [
    ...
    { id:"pot_pie",        label:"Double-Crust Pot Pie",      text:`Double-Crust Pot Pie bubbled invitingly under its golden lid, the savory filling thick with butter and deep comfort. "A meal that wraps you up like a warm blanket," MJ noted as she served hearty portions to everyone. The room quieted as forks dug in, the rich gravy and flaky crust speaking directly to the growing sense of abundance. The moms exchanged soft looks of satisfaction while the professor observed the scene unfolding.`, daughterLbs:8, momLbs:3, mjLbs:4, rel:5 },
  ],
  3: [
  ...
  4: [
    ...
    { id:"lasagna",        label:"Deep-Dish Lasagna",         text:`Deep-Dish Lasagna layered with rich sauces and multiple cheeses filled the entire kitchen with an irresistible savory aroma. "Layers of care, one on top of the other," MJ said warmly while portioning out hearty servings. Everyone ate with clear appreciation, the comforting dish encouraging second helpings around the table. The professor watched as the group settled deeper into the welcoming routine.`, daughterLbs:11, momLbs:4, mjLbs:6, rel:6 },
  ...
  5: [
    { id:"chicken_pot",    label:"Chicken Pot Casserole",     text:`Chicken Pot Casserole brought hearty warmth to the kitchen, its creamy filling bubbling invitingly under a golden crust. "A dish you bring to someone who needs feeding, because we all need it sometimes," MJ murmured softly while serving generous portions. The visibly larger daughters and moms savored every comforting bite as the room filled with satisfied quiet. The professor watched the growing sense of family and abundance deepen with each lesson.`, daughterLbs:12, momLbs:5, mjLbs:7, rel:7 },
