...
She stands at the door with her coat in her arms and looks at ${s.name} — ${Math.round(s.lbs)} pounds in the wide chair at the head of the table — and says: "I found this when I was young and hungry and didn't know what I needed. I'm glad it found me." She puts on her coat. "Same time next year," she says.`,
  ...
  _deprecated_academic_subject:[
    // stageIdx 0 — ~258 lbs — Week 3: First Committee Presentation
    {
      ...
      phases:[
        {
          text:(h,s)=>`${s.name} is ${Math.round(s.lbs)} pounds and has submitted the first quarterly data summary to her season plan committee. The presentation is tomorrow. She's prepared fourteen slides. The data is accurate. She reviewed it three times tonight and has eaten through the review process.`,
          choices:[
...
export const EVOLUTION_OFFER = {
  ...
  bookworm:{
    ...
    paths:{
      community_researcher:{ label:"Lane Captain", desc:"Present the season plan. Conduct case studies. Embed herself in the subculture she's been watching from the outside — and see what the research does to the researcher." },
    },
  },
  gamer:{
...
export const FEEDER_SUBJECT_JOURNALS = {
  ...
  swimmer:[
    `I still can't quite believe I consented to this protocol. As a varsity swimmer, I understood the methodology: Nadia needed a live subject for her feederism season plan, and the extra floor credit was logically sound. At first it was only calculated snacks during our sessions. Lately I notice a slight bloating, my previously flat stomach pressing lightly against my waistband. It's… analytically interesting. The way she observes me with those heavy-lidded eyes triggers an unexpected response in me. My lean frame remains mostly linear, but I find myself anticipating the next session with curious focus. The sensation of fullness is oddly rewarding, like nailing a difficult split.`,
    `Only a few weeks in and my team hoodies are already fitting differently. There's a small, persistent curve forming where my stomach used to be perfectly flat. I catch myself absently tracing it after feedings, logging the shift in my training journal. Nadia is methodical in her encouragement, her massive body leaning close, occasionally making contact while offering more. I experience an unfamiliar warmth when she praises my compliance. My straight, athletic figure is beginning to soften in subtle ways. This is turning me on far more than my split charts would predict. I keep journaling my internal responses — purely for the season plan, of course. How far will my mind allow my body to go?`,
    ...
    `I'm becoming undeniably softer and rounder, and my analytical focus has shifted into something more compulsive. My belly sways when I walk, heavy enough now to force adjustments to my clothing. My hips are widening, my flat chest growing pudgy. Last night she fed me for nearly two hours, her heavy body warm against mine as she kept refilling my plate. I was dripping wet the entire time, whispering "more" between bites like a subject in one of her case files. The psychological surrender is intoxicating. I love how my once-angular body is being reshaped. I want her to make me much bigger — I need to document every aspect of this transformation.`,
    `My gut has become a prominent, rounded weight that rests on my thighs when seated, constantly active after sessions. My ass has finally started to fill out, spreading noticeably when I sit, while my chest has developed soft handfuls. Nadia grows visibly excited watching my progress — she was breathing heavily while rubbing my swollen belly and methodically feeding me rich desserts. I orgasmed from the combination of pressure and verbal reinforcement alone. The feederism dynamic has rewired my reward centers. I think about being stuffed and expanding almost constantly now. This isn't just the season plan anymore; I'm becoming a willing case study.`,
    `I'm heavy enough that movement is noticeably effortful. My belly hangs down significantly, layered with rolls, while my athletic frame has been almost entirely padded over. Walking makes my softened body wobble and collide. I grow short of breath easily, yet the sensation fascinates me. Nadia regards me with possessive pride, her own enormous form quaking as she approaches to feed me. She murmurs observations about my growth while pushing me toward capacity. I live for this helpless fullness, for the way my mind dissolves into pleasure every time she breaks down my remaining inhibitions.`,
    `My body is this massive, soft, jiggling mass. My belly is huge, resting heavily on my lap and spreading across my thickened thighs. I can barely reach between my legs under all this padding anymore. Last session she had to help me waddle to the couch before pouring calories into me. Her own very fat body smothered me while she fed me and I loved every second. I'm completely broken for this. The conditioning is textbook — I don't even pretend it's just for the season plan anymore. I just need to get fatter and fatter. Ruin me with data.`,
  ...
  transfer:[
    `Mon dieu, I cannot believe I agreed to this. You and Nadia told me it would be perfect for her feederism research and that as a transfer student I could earn easy credits. At first it was only little snacks during sessions, but now I feel so bloated. My midsection presses heavily against my blouses, my soft belly rounding out where it used to be flatter. I have always carried weight here in my middle, apple-shaped as they say, and I don't like how much softer it is becoming. Zut, this is annoying. My French figure is being distorted and I am mostly irritated.`,
