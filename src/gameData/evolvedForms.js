...
export const FEEDER_SUBJECT_JOURNALS = {
  ...
  bookworm:   Array(11).fill(null).map((_,i)=>`[placeholder: bookworm subject journal, entry ${i+1}]`),
  influencer: Array(11).fill(null).map((_,i)=>`[placeholder: influencer subject journal, entry ${i+1}]`),
  athlete:    Array(11).fill(null).map((_,i)=>`[placeholder: athlete subject journal, entry ${i+1}]`),
  artsy:      Array(11).fill(null).map((_,i)=>`[placeholder: artsy subject journal, entry ${i+1}]`),
  overachiever:Array(11).fill(null).map((_,i)=>`[placeholder: overachiever subject journal, entry ${i+1}]`),
  sorority:   Array(11).fill(null).map((_,i)=>`[placeholder: sorority subject journal, entry ${i+1}]`),
  transfer:   Array(11).fill(null).map((_,i)=>`[placeholder: transfer subject journal, entry ${i+1}]`),
  quiet:      Array(11).fill(null).map((_,i)=>`[placeholder: quiet subject journal, entry ${i+1}]`),
  gamer:      Array(11).fill(null).map((_,i)=>`[placeholder: gamer subject journal, entry ${i+1}]`),
  psych:      Array(11).fill(null).map((_,i)=>`[placeholder: psych subject journal, entry ${i+1}]`),
  farm_girl:  Array(11).fill(null).map((_,i)=>`[placeholder: farm_girl subject journal, entry ${i+1}]`),
};
