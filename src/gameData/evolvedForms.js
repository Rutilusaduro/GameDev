...
The agenda says: progress updates, enrichment activities, wellness notes. The room has its own agenda.`,
    choices:[
      ...
      {id:"leftover_trays",label:"Bring kitchen leftovers — call it a tasting",
       result:`Daisy opens foil from last night's galley. The moms do not wait for plates. Leftovers become the meeting. Mrs. Monroe asks if there is more. There is.`,
       momGain:12,rel:7,suspDelta:0},
    ],
  },
  health_unit:{
...
"I haven't been weighed since my last physical," she says. She looks at the scale. "Can I—"`,
  ...
  leftover_tuesday:{
    label:"Leftover Tuesday",
    apCost:1,
    text:`The galley trays from last night are still warm. Daisy lines them on the lounge table. Residents sit. Forks move.`,
    choices:[
      {id:"open_table",label:"Open table — everyone eats what they want",
       result:`Foil comes off. Nobody asks permission. Daisy watches the room get quieter and rounder in the same hour.`,
       classGain:10,lbs:4,rel:6,suspDelta:0},
      {id:"seconds_first",label:"Serve seconds before firsts are done",
       result:`She restocks while they are still chewing. The second tray is the point. Someone laughs and keeps eating.`,
       classGain:14,lbs:6,rel:8,suspDelta:1},
      {id:"send_home",label:"Pack extras for the ride home",
       result:`Containers leave with residents and moms. Tuesday continues in other kitchens. Daisy keeps one tray for the floor.`,
       classGain:8,momGain:6,lbs:3,rel:7,suspDelta:-1},
    ],
  },
};
...
export const FEEDER_SUBJECT_JOURNALS = {
  cheerleader:[
    ...
    `My body is so huge and heavy I mostly just sit or lie down now. Rolls on rolls spill over my sides and lap, my massive ass spreading out beneath me and my bust overflowing whatever I try to wear. Moving is getting hard but every wobble turns me on so much. My RA gets crazy excited seeing how massive I'm becoming. She buries her face in my belly while feeding me, moaning about how perfect my growing body is. I crave that tight, stuffed feeling and the way she worships every new pound. I'm still giving it my all — go bigger team!`,
    ...
    `Everything about me is gigantic and super hard to move. My breasts rest heavily on top of my massive belly that spreads out wide, while my ass creates a huge soft cushion beneath me. I need help shifting around now. My RA is obsessed with how huge I've gotten. She spends hours rubbing my endless rolls while force-feeding me, telling me how beautiful my blubber is. I'm constantly turned on by my own size. I don't want this to stop — keep pumping me up, make me your biggest star!`,
  ...
  swimmer:[
    `I still can't quite believe I signed the season plan. My RA laid it out on my training log — carb targets, evening feedings, Lane Captain perks if I commit. At first it was calculated snacks after hall rounds. Lately my flat stomach presses my waistband after sessions. Analytically interesting. The way she watches me eat triggers something I didn't budget for. I keep anticipating the next feeding like a meet day. Fullness hits like a good set — earned, warm, hard to walk away from.`,
  ...
  influencer:[
    ...
    `Everything about me is gigantic and almost impossible to move. My breasts rest heavily on top of my massive belly that spreads out wide, while my enormous ass makes a huge soft base underneath. I need help shifting positions constantly now. My RA is obsessed with my size. She spends hours rubbing my endless rolls while force-feeding me, telling me how insanely sexy my exaggerated hourglass has become. I'm constantly turned on by my own body and the power it gives me. Don't stop — pump me up and make me the biggest influencer ever.`,
  ...
  athlete:[
    ...
    `My body is so massively round and heavy that I mostly sit or lie down now. Deep rolls spill over my sides and my huge rounded belly dominates everything. My ass has become an enormous soft sphere beneath me. Moving is difficult but every wobble feels incredible, like my whole body is built for pleasure now. My RA gets so excited by how perfectly round I've grown. She buries her face in my belly while feeding me, moaning about my spherical shape. I crave being stuffed until I feel like I might pop. This roundness is my new obsession.`,
    ...
    `Everything about me is gigantic, round, and almost immobile. My massive rounded breasts rest on top of my huge spherical belly that spreads out wide in every direction, while my ass makes an enormous padded base. I need help to shift at all now. My RA is obsessed with how round I've become. She spends hours rubbing and feeding my endless curves, telling me how beautiful my fully spherical body is. I'm constantly turned on by how round and heavy I am. Keep going — make me bigger and rounder.`,
  ...
  artsy:[
    ...
    `My body is so huge and heavy I mostly sit or lie down now. Rolls spill over my sides and lap in deep, artistic folds. My ass spreads wide beneath me and my softened chest rests heavily. Moving is difficult but every wobble sends waves of pleasure through me, like my entire canvas is alive with sensation. My RA gets so excited by how much I've grown. She buries her face in my belly while feeding me, whispering how perfect my expanding form is. I crave that tight, overfull feeling and the psychological release it brings. My mind has fully embraced this new aesthetic.`,
    ...
    `Everything about me is gigantic and nearly immobile. My softened chest rests on top of my massive belly that spreads out wide, while my huge ass creates a vast cushioned base. I need help shifting positions now. My RA is obsessed with my transformation. She spends hours rubbing my endless rolls while force-feeding me, telling me how breathtaking my lost-boyish form has become. I'm constantly aroused by my own size and the psychological depth of this surrender. Keep pushing me — make me your largest masterpiece.`,
  ...
  sorority:[
    ...
    `Everything about me is gigantic and almost impossible to move. My enormous breasts rest heavily on top of my massive belly that spreads out wide, while my huge ass makes a soft base underneath. I need help shifting positions constantly. My RA is obsessed with my size. She spends hours rubbing my endless rolls while force-feeding me, telling me how insanely sexy my top heavy body has become. I'm constantly turned on by my own massive chest and curves. Keep pumping me up — make me the biggest.`,
  ...
  quiet:[
    `I'm not sure why I agreed to this… my RA said the floor program sounded harmless at first, but now my body is already changing. My hips feel a little wider, my thighs gently brushing when I walk the hall. There's a small, soft pouch forming just below my waist, making my skirts sit differently. My bottom feels rounder too, pressing more into the chair when I sit. I keep my voice quiet when she brings food, murmuring that I shouldn't eat so much. But I still do. I tell myself it's only temporary, that I can stop anytime. Yet every time the plate arrives I eat in silence, feeling the subtle new fullness settle low in my pear-shaped frame. I'm still the same quiet resident… just a little softer. I hope no one notices yet.`,
