...
export const ORIGIN_DECKS = {
  ...
  16: [
    { id: 'sophia_dissertation_stress', label: 'Season plan stress', voiceLine: '"Baseline check. I am the baseline."', psych: P(35, 25, 25, 55), gainStance: 'opposed', register: 'double_check' },
