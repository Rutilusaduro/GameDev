...
export const DEVICES = {
  ...
  // ── Player personal inventions (Professor self-equip) ─────────
  controlled_bloating_rig: {
    id: 'controlled_bloating_rig',
    ...
    equipTarget: 'self',
    selfSlot: 'waist',
    baseDeviceId: 'auto_bloating_belt',
    unlockRecipeId: 'recipe_controlled_bloating',
    uniqueInteractionTags: ['player_bloat', 'controlled_pulse'],
    tier: 2,
    stability: 0.62,
    risk: 0.38,
    effectStrength: 0.55,
    rarity: 'rare',
    growthProfile: { growthMethod: 'bloat', zoneBias: 'belly', growthIntensity: 'gradual', sensation: 'pressure' },
    desc: 'Your refinement of Talia\'s belt — gentler passive bloat, but a manual Tighten pulse can force a brutal swell when you choose.',
    weeklyEffect: {
      gainLbs: [1, 2],
      bodyOverride: { stateType: 'bloated', stageBump: 1, durationWeeks: 1 },
    ...
    malfunctions: [
      { tier: 'moderate', weight: 3, text: 'Tighten pulse overruns — her waist balloons past the safe limit.', effect: { gainLbs: [3, 6], bodyOverride: { stateType: 'bloated', stageBump: 3, durationWeeks: 2 } } },
    ],
  },
  precision_feeder_arm: {
    id: 'precision_feeder_arm',
    ...
    equipTarget: 'self',
    selfSlot: 'torso',
    baseDeviceId: 'auto_feeder_arm',
    unlockRecipeId: 'recipe_precision_feeder',
    uniqueInteractionTags: ['player_feed', 'burst_feed'],
    tier: 2,
    stability: 0.68,
    risk: 0.32,
    effectStrength: 0.6,
    rarity: 'rare',
    growthProfile: { growthMethod: 'feed', zoneBias: 'bodyType', growthIntensity: 'steady', sensation: 'fullness' },
    desc: 'A calibrated feeder you wear — slow base drip, or Burst Feed when she needs to be overwhelmed.',
    weeklyEffect: { gainLbs: [2, 4], psychDelta: { dependence: 2 } },
    malfunctions: [
      { tier: 'moderate', weight: 3, text: 'Burst mode sticks — portions stack faster than she can swallow.', effect: { gainLbs: [5, 8], psychDelta: { dependence: 4 } } },
    ],
  },
  stabilized_paste_printer: {
    id: 'stabilized_paste_printer',
    label: 'Stabilized Paste Printer',
    icon: '🖨️',
    form: 'attachment',
    attachSlot: 'feedSource',
    attachesTo: ['auto_feeder_arm', 'precision_feeder_arm'],
    playerInvention: true,
    equipTarget: 'self',
    selfSlot: 'arms',
    baseDeviceId: 'calorie_paste_printer',
    unlockRecipeId: 'recipe_stabilized_paste',
    uniqueInteractionTags: ['player_paste', 'psych_bonus'],
    tier: 2,
    stability: 0.72,
    risk: 0.28,
    effectStrength: 0.5,
    rarity: 'rare',
    growthProfile: { growthMethod: 'feed', zoneBias: 'bodyType', growthIntensity: 'steady', sensation: 'fullness' },
    desc: 'Less efficient paste, but stabilized — her gains sometimes leave a trace on you.',
    weeklyEffect: { gainLbs: [1, 3], psychDelta: { fixation: 1 } },
    malfunctions: [],
  },
  measured_bloat_canister: {
    id: 'measured_bloat_canister',
    ...
    equipTarget: 'self',
    selfSlot: 'waist',
    baseDeviceId: 'bloating_gas_canister',
    unlockRecipeId: 'recipe_measured_bloat',
    uniqueInteractionTags: ['residual_swell', 'player_bloat'],
    tier: 2,
    stability: 0.7,
    risk: 0.35,
    effectStrength: 0.55,
    rarity: 'rare',
    growthProfile: { growthMethod: 'gas', zoneBias: 'belly', growthIntensity: 'gradual', sensation: 'pressure' },
    desc: 'Reduced initial bloat with lingering Residual Swell — amplifies other feeding until you vent it.',
    useEffect: {
      gainLbs: [1, 3],
      bodyOverride: { stateType: 'bloated', stageBump: 1, durationWeeks: 2 },
      psychDelta: { dependence: 2 },
    },
    malfunctions: [
      { tier: 'moderate', weight: 3, text: 'Residual swell overruns — bloat refuses to vent cleanly.', effect: { gainLbs: [3, 5] } },
    ],
  },
  adaptive_growth_harness: {
    id: 'adaptive_growth_harness',
    ...
    selfSlot: 'waist',
    baseDeviceId: 'auto_bloating_belt',
    unlockRecipeId: 'recipe_adaptive_harness',
    uniqueInteractionTags: ['adaptive_stack', 'device_synergy'],
    tier: 3,
    stability: 0.58,
    risk: 0.42,
    effectStrength: 0.65,
    rarity: 'rare',
    growthProfile: { growthMethod: 'feed', zoneBias: 'full', growthIntensity: 'steady', sensation: 'fullness' },
    desc: 'Passive gain scales with how rigged she already is — more devices, more yield.',
    weeklyEffect: { gainLbs: [1, 2], psychDelta: { dependence: 1 } },
    malfunctions: [
      { tier: 'moderate', weight: 3, text: 'Harness overcharges another rig without warning.', effect: { gainLbs: [2, 5], psychDelta: { obsession: 2 } } },
    ],
  },
};
