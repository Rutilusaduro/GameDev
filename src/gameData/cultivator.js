...
} from '../textEngine/scenes/cultivator/vignettes.js';
...
export function getGrowthVignette(beforeStageId, gain, stagesJumped) {
  return renderCultivatorGrowth(beforeStageId, gain, stagesJumped);
}

export function getDigestVignette(reneeStageId, testerName, stagesJumped, isLate) {
  return renderCultivatorDigest(reneeStageId, testerName, stagesJumped, isLate);
}

export function getStageUpText(stageId, testerName) {
