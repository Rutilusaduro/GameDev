...
export const FLOOR_SCENES = [
  ...
  { id:"mood_stressed", target:"student", filter:s=>s.mood==="stressed",
    ...
    choices:[
      ...
      { label:"Walk her to the kitchen", effect:{gain:[4,8],mood:"content",rel:6}, result:s=>`You take ${s.name} to the galley. She eats standing. The energy drink stays on the desk. She does not.` },
    ] },
  { id:"mood_tired", target:"student", filter:s=>s.mood==="tired",
    ...
    choices:[
      ...
      { label:"Leave a tray on her lap",   effect:{gain:[3,6],mood:"content",rel:5}, result:s=>`You set food where her hands already are. She eats without sitting up. The nap becomes a meal.` },
    ] },
  { id:"mood_nervous", target:"student", filter:s=>s.mood==="nervous",
    ...
    choices:[
      ...
      { label:"Sit with her until she eats", effect:{gain:[4,7],mood:"content",rel:8}, result:s=>`You do not talk her out of the jitters. You put a plate down. She finishes it. The phone stays face-down.` },
    ] },
  { id:"mood_focused", target:"student", filter:s=>s.mood==="focused",
    ...
    choices:[
      ...
      { label:"Park a tray at her elbow",     effect:{gain:[4,8],mood:"focused",rel:4}, result:s=>`You do not interrupt the zone. You feed it. She eats without looking up. The notes stay immaculate.` },
    ] },
  { id:"mood_excited", target:"student", filter:s=>s.mood==="excited",
    ...
    choices:[
      ...
      { label:"Take her to the terrace with trays", effect:{gain:[6,11],mood:"excited",rel:7}, result:s=>`You walk her up with food. The excitement has somewhere to go. The trays do not come back.` },
    ] },
  ...
  { id:"arch_cheerleader", target:"student", filter:s=>s.archetype==="cheerleader",
    ...
    choices:[
      ...
      { label:"Bring the squad leftovers",  effect:{gain:[5,10],mood:"content",rel:7}, result:s=>`You walk a tray to the cheer room. Uniforms strain. Nobody files a complaint.` },
    ] },
  { id:"arch_swimmer", target:"student", filter:s=>s.archetype==="swimmer",
    ...
    choices:[
      ...
      { label:"Meet her after the last lap",     effect:{gain:[6,11],mood:"content",rel:8}, result:s=>`You wait with a loaded tray. She eats wet-haired and hungry. The log waits.` },
    ] },
  { id:"arch_bookworm", target:"student", filter:s=>s.archetype==="bookworm",
    ...
    choices:[
      ...
      { label:"Leave a stash in the annex",  effect:{gain:[4,8], mood:"content",rel:7}, result:s=>`You put food where she already hides. She finds it. She finishes it. The notes get a butter stain she does not mind.` },
    ] },
  { id:"arch_influencer", target:"student", filter:s=>s.archetype==="influencer",
    ...
    choices:[
      ...
      { label:"Film a night-round haul",             effect:{gain:[7,12],mood:"excited",rel:8}, result:s=>`She films the corridor after hours. Chat loves the fridge light. She eats on camera like it was always the bit.` },
    ] },
  { id:"arch_athlete", target:"student", filter:s=>s.archetype==="athlete",
    ...
    choices:[
      ...
      { label:"Walk her to the dining nook",          effect:{gain:[6,12],mood:"content",rel:8}, result:s=>`Recovery, plated. She eats like the week was a workout. The table agrees.` },
    ] },
  { id:"arch_artsy", target:"student", filter:s=>s.archetype==="artsy",
    ...
    choices:[
      ...
      { label:"Sit her in the annex with a tray", effect:{gain:[5,10],mood:"content",rel:8}, result:s=>`Quiet light, a plate, no passing traffic. She draws the food. Then she eats the subject.` },
    ] },
  { id:"arch_gamer", target:"student", filter:s=>s.archetype==="gamer",
    ...
    choices:[
      ...
      { label:"Park snacks at the keyboard", effect:{gain:[5,10],mood:"content",rel:6}, result:s=>`You do not make her pause the queue. Food arrives in reach. She eats between matches. The body pillow takes more of her.` },
    ] },
  { id:"arch_sorority", target:"student", filter:s=>s.archetype==="sorority",
    ...
    choices:[
      ...
      { label:"Book the terrace for the after", effect:{gain:[6,12],mood:"excited",rel:8}, result:s=>`The event ends. The roof does not. Trays travel. She eats in the air she booked.` },
    ] },
  { id:"arch_overachiever", target:"student", filter:s=>s.archetype==="overachiever",
    ...
    choices:[
      ...
      { label:"Schedule a private weigh-in",    effect:{gain:[3,6], mood:"content",rel:7}, result:s=>`You put the number on the calendar. She treats it like extra credit. She eats like the number is the assignment.` },
    ] },
  { id:"arch_quiet", target:"student", filter:s=>s.archetype==="quiet",
    ...
    choices:[
      ...
      { label:"Eat with her in the annex",        effect:{gain:[4,8], mood:"content",rel:9},  result:s=>`No audience. A plate. She talks more than she meant to. She eats more than she meant to.` },
    ] },
  { id:"arch_transfer", target:"student", filter:s=>s.archetype==="transfer",
    ...
    choices:[
      ...
      { label:"Walk her the night-wing fridge",    effect:{gain:[6,11],mood:"content",rel:8},  result:s=>`You show her the unofficial hours. She learns the floor by eating it.` },
    ] },
  // ── WEIGHT-STAGE-BASED ───────────────────────────────────────
  { id:"stage_early", target:"student", filter:s=>getStage(s.lbs).id<=2,
    ...
    choices:[
      ...
      { label:"Offer a private weigh-in later",    effect:{gain:[2,5], mood:"content",rel:6}, result:s=>`You put the scale on the calendar, not the rumor mill. She eats less scared. She eats more.` },
    ] },
  { id:"stage_mid", target:"student", filter:s=>{const id=getStage(s.lbs).id;return id>=3&&id<=4;},
    ...
    choices:[
      ...
      { label:"Keep her in the dining nook",       effect:{gain:[5,9], mood:"content",rel:7}, result:s=>`You do not send her back to her desk. The table keeps her. Seconds keep arriving.` },
    ] },
  { id:"stage_heavy", target:"student", filter:s=>getStage(s.lbs).id>=5,
    ...
    choices:[
      ...
      { label:"Hold the lounge for her after hours", effect:{gain:[6,11],mood:"content",rel:9}, result:s=>`You lock the door. She takes the wide chair. The food is already there. She does not pretend this is a meeting.` },
    ] },
  // ── HALL-WIDE ────────────────────────────────────────────────
  ...
  { id:"hall_group_project", target:"hall",
    ...
    choices:[
      ...
      { label:"Keep the kitchen open after",      effect:{gain:[5,10]}, result:"You do not call time. Menus become meals. The hypothetical context becomes dinner." },
    ] },
  { id:"hall_birthday", target:"hall",
    ...
    choices:[
      ...
      { label:"Walk leftovers door to door",       effect:{gain:[5,10]}, result:"The cake leaves the lounge. Doors open. Nobody pretends they were asleep." },
    ] },
  { id:"hall_slump", target:"hall",
    ...
    choices:[
      ...
      { label:"Open the annex for naps and plates", effect:{gain:[3,7]}, result:"Soft light, closed door, a tray that does not leave. The slump becomes a second meal." },
    ] },
  { id:"hall_potluck", target:"hall",
    ...
    choices:[
      ...
      { label:"Send leftovers down the wing",        effect:{gain:[7,13]}, result:"Containers travel. Doors stay open. The potluck becomes a night round with better packaging." },
    ] },
  { id:"hall_extended", target:"hall",
    ...
    choices:[
      ...
      { label:"Move the rest to the annex",          effect:{gain:[4,8]},  result:"The lounge empties into the quiet room. Plates follow. The session ends when the food does." },
    ] },
  { id:"hall_night_noise", target:"hall",
    ...
    choices:[
      ...
      { label:"Open the annex as overflow",     effect:{gain:[4,8]},  result:"The corridor drains into the quiet room. Plates follow. Housing hears nothing." },
    ] },
  { id:"hall_new_chairs", target:"hall",
    ...
    choices:[
      ...
      { label:"Move a chair into the annex",    effect:{gain:[3,7]},  result:"The quiet room gets the widest seat. Someone sits and does not leave. Food finds her." },
    ] },
