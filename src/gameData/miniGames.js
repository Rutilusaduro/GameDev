...
export const FAIR_DARCY_WEIGHTS = [310, 350, 390, 430, 465, 500];

// Milestone popup text at 100% / 150% / 200% / 250% fullness, indexed by stageIdx
export const FAIR_FULLNESS_MILESTONES = {
  100:[
...
export const FAIR_WEIGH_IN_TEXT = [
...
export const FAIR_TAUNT_POPUPS = [
