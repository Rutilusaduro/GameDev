...
export const GOSSIP = [
  ...
  { speakerId:13, targetId:3, attitude:"warm",
    lines:{
      low:[
        `Serena came by the kitchen and I gave her some of the test batch. She ate three without asking what was in them. That's my kind of person.`,
        `I told Serena she should come to my study session. She said she'd think about it. She showed up. She finished everything on the table.`,
      ],
      mid:[
        `I've been making the richer stuff for Serena lately. She has this capacity — like she was built for it. I just appreciate that she eats like she means it.`,
        `Serena looks different now. Good different. Like she's settled into herself. I gave her the cinnamon roll recipe and she texted me at 11pm that it worked.`,
      ],
      high:[
        `I made extra specifically for Serena this week. She's wonderful to feed — that genuine happiness when she eats something she loves. It lights up the whole room.`,
        `Serena asked if I could teach her to bake. I said yes. She learned the banana bread in twenty minutes and ate half of it immediately. I have never been prouder.`,
      ],
      blob:[
        `I don't need to bring food to Serena anymore — she texts me what she wants and I make it. We have an understanding. Some people you just know are going to eat well.`,
        `I bake for Serena because she deserves it. She eats properly — completely, gratefully, with her whole body. That's what food is for.`,
      ],
    },
    offerHelp:`I've been making extra for Serena anyway. I'll just make sure she gets the good version.`,
    helpReason:"always has exactly what Serena needs already made and ready",
    helpMultiplier:1.4,
  doubleDown:[
    {atLbs:200, addMult:0.15, line:"I've started adjusting recipes specifically for Serena. More butter. Richer. She deserves the real thing."},
    {atLbs:250, addMult:0.20, line:"Serena told me she looks forward to Tuesdays more than anything else. I said me too. I doubled the batch size."},
    {atLbs:300, addMult:0.25, line:"I've been testing higher-calorie versions of everything. I call them the Serena recipe. She doesn't know they're named after her yet."},
  ],
  },
  { speakerId:13, targetId:14, attitude:"warm",
    lines:{
      low:[
        `Mary Jane stopped by with preserved peaches and I almost cried. She has actual larder instincts. This is someone who understands.`,
        `I asked Mary Jane what she uses for her cornbread. We sat down and talked for two hours. We both missed our afternoon classes. Worth it.`,
      ],
      mid:[
        `Mary Jane and I trade recipes now — she gave me her grandmother's sweet potato pie, I gave her my banana bread. We're both constantly testing the other's version.`,
        `Mary Jane knows exactly what she's doing. She's not test-baking — she's building a legacy. I admire that more than I can explain.`,
      ],
      high:[
        `I made Mary Jane's grandmother's recipe for my class. They loved it. I texted her to tell her. She said 'that's what it's for.' I had to sit down.`,
        `Mary Jane and I are basically the same person from different food traditions. This connection is something I didn't know I needed.`,
      ],
      blob:[
        `Mary Jane and I understand each other without having to explain. We cook from different wells and we're building different things, but we both know what we're doing.`,
        `Mary Jane brought over cast iron she didn't need anymore. I cried a little. She said 'you'll use it right.' She knew I would.`,
      ],
    },
    offerHelp:`Mary Jane knows the best suppliers — the real stuff, not the campus vendor nonsense. I can make an introduction that'll set everything up properly.`,
    helpReason:"has connections to farm suppliers nobody else knows about",
    helpMultiplier:1.32,
  doubleDown:[
    {atLbs:200, addMult:0.15, line:"Mary Jane showed me a rendering technique that changes everything. Everything I make is better now."},
    {atLbs:250, addMult:0.20, line:"I've been learning from Mary Jane's approach — patience, quality over speed. My recipes have gotten richer and I think it shows."},
    {atLbs:300, addMult:0.25, line:"Mary Jane and I did a joint cooking session last weekend. Neither of us measured anything. We both ate everything. Still full. Perfect."},
  ],
  },
