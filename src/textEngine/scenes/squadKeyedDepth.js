...
registerModuleVariants('campus.spaceObs', [{ when: {"studentId":0,"campusLocale":"gym","stageMin":5,"stageMax":9}, weight: 4, text: ["Madeline chooses the desk with the widest arm — hypothesis confirmed weekly."] }]);
registerModuleVariants('campus.spaceObs', [{ when: {"studentId":1,"campusLocale":"lecture_hall","stageMin":5,"stageMax":9}, weight: 4, text: ["Brittany tests equipment like team gear — what fits, what groans, what earns respect."] }]);
