...
registerModuleVariants('campus.spaceObs', [{ when: {"studentId":0,"campusLocale":"gym","stageMin":5,"stageMax":9}, weight: 4, text: ["Brittany tests equipment like team gear — what fits, what groans, what earns respect."] }]);
registerModuleVariants('campus.spaceObs', [{ when: {"studentId":1,"campusLocale":"floor meeting_hall","stageMin":5,"stageMax":9}, weight: 4, text: ["Cassidy chooses the desk with the widest arm — season plan confirmed weekly."] }]);
