...
registerPool('diary.salon_appetit.s6._f4', [
  { when: {}, text: [
    ...
    " Dr. Mori followed the coq au vin and never left. Faculty lends prestige; Chloé lends hunger.",
    " Faculty at the table now. Coq au vin opened the door; dessert kept them.",
  ]},
]);
...
registerPool('diary.pharmacist.s8._f7', [
  { when: {}, text: [
    ...
    "Hypothesis retired. Campus gains. I gain. Proof of concept complete.",
  ]},
]);
