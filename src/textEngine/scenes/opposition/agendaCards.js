...
// Per-card AIB agenda resolve pools — keyed by card id for agendaResolveLine().
...
registerPool('opposition.agenda.device_confiscation', [
  { when: {}, text: [
...
registerPool('opposition.agenda.mandatory_fitness', [
  { when: {}, text: [
