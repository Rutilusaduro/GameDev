...
registerPool('wi.aibMandatory', [
  {
    when: {},
    text: [
      'Chairwoman Vance\'s clerk left a stamped notice on your desk: mandatory documented weigh-in for {subject.name}. The Academic Inquiry Board will receive the reading.',
