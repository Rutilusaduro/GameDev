...
registerPool('ge.garment', [
  ...
  { when: { archetype: 'swimmer', stageMin: 6 }, text: ['the team hoodie, buttons working hard', 'whatever layers still button'] },
  { when: { archetype: 'bookworm', stageMin: 3, stageMax: 5 }, text: ['her cardigan', 'the button-front she favors'] },
  { when: { archetype: 'swimmer', stageMin: 3, stageMax: 5 }, text: ['her team hoodie', 'the button-front she favors'] },
  ...
  { when: { archetype: 'nursing', stageMin: 3, stageMax: 5 }, text: ['her cardigan and scrub pants', 'her nursing-program layers'] },
