...
const W = 4;
const ID = 18;
const TALIA = { studentId: ID, custom: false };

registerModuleVariants('wi.replyDialogue', [
  { when: { ...TALIA, corruption: [0], stageMax: 3 }, weight: W, text: [
  ...
  { when: { ...TALIA, corruption: [0], stageMin: 4, stageMax: 6 }, weight: W, text: [
  ...
  { when: { ...TALIA, corruption: [1], stageMax: 6 }, weight: W, text: [
  ...
  { when: { ...TALIA, corruption: [2], stageMax: 6 }, weight: W, text: [
  ...
  { when: { ...TALIA, corruption: [0], stageMin: 7 }, weight: W, text: [
...
registerModuleVariants('enc.reach', [
  { when: { ...TALIA, corruption: [1] }, weight: W, text: [
...
registerModuleVariants('enc.giveIn', [
  { when: { ...TALIA, corruption: [2] }, weight: W, text: [
