...
registerModuleVariants('device.catalog.growth_accelerator_chamber', [{ when: {}, text: ["Sealed chamber warmth accelerates deposition — pleasurable, unpredictable growth.", "Radiation field hums; adipose answers faster than caution allows."] }]);
