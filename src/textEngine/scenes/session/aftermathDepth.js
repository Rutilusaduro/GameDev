...
registerModuleVariants("session.aftermath.light._f1", [{ when: {}, text: ["She finishes unhurried, pleased with how the session went.", "Pleasant fullness settles; she savors the end of the meal like dessert."] }]);
registerModuleVariants("session.aftermath.light", [{ when: {}, text: ["{session.aftermath.light._f1}", "{session.aftermath.light._f1}"] }]);
registerModuleVariants("session.aftermath.full._f1", [{ when: {}, text: ["Middle drum-tight with warmth; she does not attempt to stand.", "She leans back and stays back, both hands on her full round belly, breathing carefully."] }]);
...
registerModuleVariants("session.aftermath.stuffed._f1", [{ when: {}, text: ["Past comfortable and into wonder — she presses hands flat, feeling every ounce.", "She has gone very still, spectacularly full, belly a round warm mass under her palms."] }]);
...
registerModuleVariants("session.aftermath.packed._f1", [{ when: {}, text: ["She is enormous with food — belly rounded, firm, extraordinary under her hands.", "She keeps her hands on her belly, feeling weight, heat, the truth of how much."] }]);
