...
registerPool('campus.sighting', [
  ...
  // Cassidy — varsity swimmer
  { when: { archetype: 'swimmer', weightBand: 'lean' }, priority: 4,
    text: [
      '{subject.name} is on the pool deck before sunrise — swim cap on, logging splits between sets.',
      'You pass the natatorium; {subject.name} is doing cool-down laps, hair still damp, protein shaker waiting on the tile.',
      'She counts strokes like homework. The lane clock does not argue with her.',
    ] },
  { when: { archetype: 'swimmer', weightBand: 'mid' }, priority: 4,
    text: [
      '{subject.name} still hits morning practice, but she pauses between sets for a second carb bowl — "recovery," she says, already reaching for more.',
      "{subject.name}'s team jacket won't zip. She keeps coaching freshmen through drills anyway, voice sharp, belly softer.",
      'Between laps she checks her meal log and adds a post-practice entry without embarrassment.',
    ] },
  { when: { archetype: 'swimmer', weightBand: 'heavy' }, priority: 4,
    text: [
      '{subject.name} commands from the pool deck now — whistle in hand, belly rounding under her parka, freshmen bringing her snacks between sets.',
      'Practice slows when {subject.name} demonstrates a turn; she gets winded, laughs, and sends someone for pasta.',
      'The team treats her appetite like another training metric. Nobody questions the woman who built the culture.',
    ] },
  { when: { archetype: 'swimmer', weightBand: 'extreme' }, priority: 4,
    text: [
      '{subject.name} holds court from a reinforced pool chair, belly spilling past her knees, still timing splits for the squad between bites.',
      'Two swimmers help {subject.name} stand so she can demonstrate a stroke. She makes it halfway, claps anyway, orders team dinner.',
      'The natatorium orbits her like lanes around a buoy — she eats, points, and nobody argues with the captain.',
    ] },
  // Kylie — influencer
