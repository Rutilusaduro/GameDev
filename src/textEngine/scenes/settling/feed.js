...
registerPoolAutoDecompose('set.feed.stuffing', [
  ...
  { when: { stageMin: 11 }, weight: 3, text: [
    ...
    `She is already vast and you make her fuller. This is the understanding: that there is always more room, that her capacity keeps expanding to meet what you bring, that stuffing a girl at this scale requires patience and presence and a willingness to keep offering past the point where she thinks she's done. She always discovers she wasn't. The discovery never stops being something.`,
  ]},
