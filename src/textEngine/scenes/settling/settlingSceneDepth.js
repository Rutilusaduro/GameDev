...
registerModuleVariants('set.care.tend.beat', [
  { when: { studentId: 1, stageMin: 10 }, weight: W, text: [
    `Cassidy tends her own training log between your hands — discipline and comfort braided, body maintained like a lane captain.`,
  ]},
...
registerModuleVariants('set.weigh.react', [
  { when: { studentId: 1, stageMin: 10 }, weight: W, text: [
    `Cassidy logs {subject.lbs} mentally, then lets satisfaction win. "Personal best," she murmurs.`,
  ]},
  { when: { studentId: 7, stageMin: 10 }, weight: W, text: [
