...
{ when: { stage: [5], corruption: [0] }, text: ['Regional qualifier. The warm-up room was unfamiliar and everything in it — the smell, the scale, the way my body moved in the space — felt borrowed. Dana \'The Wall\' Mercer didn\'t look at me.'] },
  ...
  { when: { stage: [5] }, text: ['Regional qualifier, my first. The warm-up room smelled like liniment and chanko and I was the only former cheerleader in it.'] },
  { when: { stage: [6], corruption: [0] }, text: ['Six months in and the gap to Dana is fifty pounds and closing. I know the math because I check the math.'] },
  { when: { stage: [6], corruption: [1] }, text: ['One season in. Maya\'s 370 and I\'m 320 and the gap is closing and she knows it the same way I know it.'] },
  { when: { stage: [6] }, text: ['One season in. Fed myself between every bout — chanko, rice, all of it, my belly filling lower and heavier each break — and it nearly carried me past Dana. Nearly. The gap\'s down to fifty pounds.'] },
  { when: { stage: [7], corruption: [0] }, text: ['Conference week. The scale read 390 and the judge said it twice and Dana\'s number was 380 and I stood there in the warmup room holding that gap very still. I\'ve outweighed Dana Mercer.'] },
  { when: { stage: [7], corruption: [1] }, text: ['Conference championship. I crossed Dana on the scale — my number above hers for the first time. She stopped writing in her warmup notes and put the cap back on without finishing.'] },
  { when: { stage: [7] }, text: ['Conference meet.'] },
  { when: { stage: [8], corruption: [0] }, text: ['National qualifier. The field is enormous and I am the largest thing in it and I don\'t fully know how to hold that. I ate my way through the morning. I won.'] },
  { when: { stage: [8], corruption: [1] }, text: ['National qualifier and I\'m the heaviest in the field by a margin that makes the others go quiet. I ate through the bracket and by the final I was bigger than I\'d been.'] },
  { when: { stage: [8] }, text: ['National qualifier, press at the door. I\'m the heaviest woman in the field by a margin that makes the others quiet.'] },
  { when: { stage: [9], corruption: [0] }, text: ['National final. They read my number and the arena went quiet before it went loud.'] },
  { when: { stage: [9], corruption: [1] }, text: ['National final. The arena read my number and took a breath before it roared. Dana was the first person to find me after — she was smiling. \'Thank you,\' she said. I understood what she meant.'] },
  { when: { stage: [9] }, text: ['National final. They read my number into the broadcast and the arena took a breath before it roared.'] },
  { when: { stage: [10], corruption: [0] }, text: ['I wrote it down the night I won nationals: I stood in the middle of the dohyo, the largest competitor the sport has ever crowned, and I thought — I made this. Every bowl. Every weigh-in.'] },
...
{ when: { stage: [5], corruption: [0] }, text: ['I didn\'t deserve to be looked at yet. I ate between bouts because the coach said to, not because I understood it. My belly felt heavy and wrong and I finished lower than I wanted.'] },
  ...
  { when: { stage: [5] }, text: ['Dana \'The Wall\' Mercer, 340 pounds, didn\'t look at me once until the weigh-in.'] },
  { when: { stage: [6], corruption: [0] }, text: ['I still feel strange between bouts — eating because the strategy demands it, my belly filling lower and heavier than I expected. Dana told me to keep eating. She said it plainly, like advice.'] },
  { when: { stage: [6], corruption: [1] }, text: ['We ate in the same warmup room and talked for a few minutes before competing and it was good and then she beat me. I know where this is going. So does she.'] },
  { when: { stage: [6] }, text: ['She said \'keep eating, keep getting bigger,\' and she wasn\'t being kind, she was being honest about how she loses. I\'m going to make her right.'] },
  { when: { stage: [7], corruption: [0] }, text: ['I\'m trying to decide what to do with that feeling. I won the conference. I\'m still deciding.'] },
  { when: { stage: [7], corruption: [1] }, text: ['She knew what it meant. I knew what it meant. I won. That matters more than any feeling about it.'] },
  { when: { stage: [7] }, text: ['The board said I outweigh Dana Mercer now — first time ever — and then I went out and proved the number meant something, drove her belly-first out of the ring twice while the crowd chanted my nam'] },
  { when: { stage: [8], corruption: [0] }, text: ['I\'m still not sure what I\'m supposed to feel. Dana said she\'d out-think me. She couldn\'t. I wrote that down because I need to believe it.'] },
  { when: { stage: [8], corruption: [1] }, text: ['Dana said she\'d out-think me. She couldn\'t out-think this much weight. That\'s a fact, not a boast. I\'m still getting used to facts like that.'] },
  { when: { stage: [8] }, text: ['I ate a full staging meal before, fed in my corner through the whole bracket, and by the final I was bigger than I\'d ever been. Dana said she\'d out-think me. She couldn\'t.'] },
  { when: { stage: [9], corruption: [0] }, text: ['Dana found me first — 520 pounds, the wall I climbed over — and said she\'d come to feel what it\'s like to lose to the biggest there\'s ever been. I fed in my corner. I grew between bouts. I won.'] },
  { when: { stage: [9], corruption: [1] }, text: ['She\'d given me a rivalry worth finishing. I gave her something to have lost to. We both got what we came for.'] },
  { when: { stage: [9] }, text: ['Dana found me first — 520 pounds, the wall I climbed over — and said she didn\'t come to beat me, nobody beats me now; she came to feel what it\'s like to lose to the biggest there\'s ever been.'] },
  { when: { stage: [10], corruption: [0] }, text: ['Every pound that felt strange until it didn\'t. This is the record and the record is my body. I\'m still learning how to think of that as mine.'] },
...
{ when: { stage: [5], corruption: [0] }, text: ['I wrote down three things I did wrong. I\'ve started fixing them.'] },
  ...
  { when: { stage: [7] }, text: ['\'You crossed over,\' she said after. \' I am. After two years of being the novelty, I\'m the one they measure against.'] },
...
{ when: { stage: [5], corruption: [0] }, text: ['Timer ran. I finished early and sat with my hands in my lap while the others kept going and felt something I should have been proud of. I mostly felt unsure. The plate was clear.'] },
  ...
  { when: { stage: [6], corruption: [0] }, text: ['Circuit regular now. Four regional slots. My face on a flyer. I look at the flyer sometimes and feel like it\'s a photo of someone I\'m in the process of becoming. I\'m good at this.'] },
  { when: { stage: [6] }, text: ['Circuit regular. I have a slot on the roster at four regional events. My face is on a flyer.'] },
  { when: { stage: [7], corruption: [0] }, text: ['Regional record fell. Four years it stood, four minutes against me. They told me afterward, like I wasn\'t there, like I hadn\'t felt it give the moment I crossed it. I felt it. I kept going.'] },
  { when: { stage: [7] }, text: ['The regional record stood for four years. It stood for four minutes against me.'] },
  { when: { stage: [8], corruption: [0] }, text: ['Sponsorships. A hot sauce brand, an energy drink, a restaurant chain. My agent negotiated all of it.'] },
  { when: { stage: [8] }, text: ['Sponsorships now. A hot sauce brand, an energy drink, a restaurant chain doing promotional events. My agent — I have an agent — negotiated all of it. I ate through the signing meeting.'] },
  { when: { stage: [9], corruption: [0] }, text: ['World record is a number I keep in my head. I wake up with it. I eat toward it without loving the fact that eating toward things is what my life is. The number is getting closer.'] },
  { when: { stage: [9] }, text: ['The world record is a number I keep in my head. I wake up with it. I eat toward it. I am not there yet. I am approaching it with the same steady inevitability I bring to everything else.'] },
...
{ when: { stage: [5], corruption: [0] }, text: ['I was very good at this. I went home and ate dinner and thought about what kind of person this was making me.'] },
  ...
  { when: { stage: [6] }, text: ['This is surreal and also completely logical — I am very good at this, and the circuit needs people who are very good at this. The flyer has a good photo.'] },
  { when: { stage: [7], corruption: [0] }, text: ['I sat in the parking lot after and ate something small and told myself this was a good life. It is a good life.'] },
  { when: { stage: [7] }, text: ['I was told this afterward, as if I hadn\'t been there, as if I hadn\'t felt the record give way the moment I exceeded it. I felt it. I kept going.'] },
  { when: { stage: [8], corruption: [0] }, text: ['I ate through the signing meeting because it seemed like the right thing to do and everyone found that appropriate. I am a professional now.'] },
  { when: { stage: [8] }, text: ['Everyone found this appropriate.'] },
  { when: { stage: [9], corruption: [0] }, text: ['I am getting closer. I\'m not sure what happens after.'] },
  { when: { stage: [9] }, text: ['The number is getting closer. So am I.'] },
  { when: { stage: [10], corruption: [0] }, text: ['I eat because I\'m hungry and because I\'ve always been hungry and because that is the most honest thing I know about myself.'] },
...
{ when: { stage: [5], corruption: [0] }, text: ['First collab tonight. " We both lied. We went live and the chat found us and by the end the subscriber count had done something I didn\'t expect.'] },
  ...
  { when: { stage: [6], corruption: [0] }, text: ['Six weeks. Both of us heavier. The chat watches both numbers go up. I know what this is. I\'ve known since the first stream.'] },
  { when: { stage: [6] }, text: ['Six weeks of collabs. She\'s heavier than when we started. I am heavier than when we started. The chat comes every week to watch both numbers go up.'] },
  { when: { stage: [7], corruption: [0] }, text: ["Platform featured the collab. Editorial pick. They called it \"a new format for a specific kind of content\" which is the most diplomatic phrasing I can imagine. Wren donated the full goal."] },
  { when: { stage: [7] }, text: ["Platform featured the collab. Editorial pick. \" Wren donated the full stream goal herself in one transaction and wrote: THE FEATURE WAS DESERVED. It was deserved. I know what this is."] },
  { when: { stage: [8], corruption: [0] }, text: ['Brand contract. Both weights in the contract, both belly-sizes accounted for, both of us eating their product on camera.'] },
  { when: { stage: [8] }, text: ['Brand contract signed. Both of us. Both weights in the contract, both belly-sizes accounted for, both of us eating their product on camera for a guaranteed sum. The food is good. The sum is good.'] },
  { when: { stage: [9], corruption: [0] }, text: ['Anniversary collab. One year.'] },
...
{ when: { stage: [5], corruption: [0] }, text: ['A person called wrenWatchesEverything said she wasn\'t leaving. I turned off the camera and sat with what I\'d just started. I\'m not sure I understand it yet.'] },
  ...
  { when: { stage: [6] }, text: ['The weekly gain isn\'t a side effect of the format. It is the format.'] },
  { when: { stage: [7], corruption: [0] }, text: ['She always does. I sat with the editorial language and thought: they\'re not wrong. It is exactly what it looks like. I\'ve stopped pretending it isn\'t.'] },
  { when: { stage: [7] }, text: ['It has always been exactly what it looks like.'] },
  { when: { stage: [8], corruption: [0] }, text: ['I read the contract language three times because I kept expecting something to embarrass me. Nothing did. This is what I do now. This is legitimate.'] },
  { when: { stage: [8] }, text: ['I ate half their product before the stream started because I wanted to and because I could. Wren donated the goal before we went live. She always does.'] },
...
{ when: { stage: [5], corruption: [0] }, text: ['The rebrand felt risky and it was risky. The algorithm dipped and I watched my numbers fall and kept posting anyway because stopping would have meant the old thing had been right all along.'] },
  ...
  { when: { stage: [6] }, text: ['The brand deal came through. A clothing company that makes things in real sizes and takes real photos of real bodies.'] },
  ...
  { when: { stage: [9] }, text: ['Cultural touchstone. Journalists use that phrase in profile pieces. Residents cite me in season plan papers. I get speaking requests from places I\'ve never been.'] },
...
{ when: { stage: [5], corruption: [0] }, text: ['The numbers recovered. Doubled. The comments section is different now — more honest, more careful, like people who are relieved to finally say something.'] },
  ...
  { when: { stage: [6] }, text: ['I wore the dress on camera and cried slightly and my editor left it in and that clip has more views than anything else I\'ve posted this year.'] },
...
{ when: { stage: [5], corruption: [0] }, text: ['I went back to my station. I lost. I was not good enough yet. I\'m going to be good enough.'] },
  ...
  { when: { stage: [7] }, text: ["She put the cap back on without finishing. I made eye contact with her. \" She meant it as a compliment. I took it as one. Then I won the conference."] },
...
{ when: { stage: [5], corruption: [0] }, text: ['The newsletter went out to thirty people. I wrote it like an assignment I was grading myself on. Thirty people opened it by morning. Thirty people read what I wrote in the middle of the night.'] },
  ...
  { when: { stage: [6] }, text: ['An agent emailed. A real literary agent, with a list of authors I\'ve actually read. She said she\'d been following the newsletter and had ideas. I reread the email six times.'] },
...
{ when: { stage: [5], corruption: [0] }, text: ['I sat with that number for a long time before deciding it was a beginning and not an end.'] },
  ...
  { when: { stage: [9] }, text: ['I went to one of the halles and sat in the back and listened to residents argue about sentences I\'d written and felt something I didn\'t have a word for until later: permanence.'] },
...
{ when: { stage: [5], corruption: [0] }, text: ['First gaming + eating stream. I was nervous in a way I haven\'t been nervous about streaming in years. The viewer count did something unexpected within two hours.'] },
  ...
  { when: { stage: [7] }, text: ['My community follows every meal and every match. They know my order at six different restaurants. They track my high scores. They send delivery gifts in amounts that require a second fridge.'] },
  { when: { stage: [8] }, text: ['\' I\'ve been doing this for months. The platform finally noticed. The algorithm turned on like a light. The viewer count doubled in a week. I ate through the entire surge.'] },
  { when: { stage: [9] }, text: ['Mukbang gaming legend. My clips get remixed and cited and reposted. My setups and orders are documented on a fan wiki I did not create. \' That might be accurate.'] },
...
{ when: { stage: [5], corruption: [0] }, text: ['Session log — Week 1: New delivery driver. She confirmed the order and left. I ate everything and won a game and stayed up until four. The session was good.'] },
  ...
  { when: { stage: [6] }, text: ['Session log — Week 5: Rae added something to the order. I didn\'t ask for it. The receipt said \'complimentary\' in the notes.'] },
  { when: { stage: [7] }, text: ['Session log — Week 9: She was at my door when I placed the order. \' The building requires a code for the lobby. I let this go. Food was warm. Session went five hours.'] },
...
{ when: { stage: [5], corruption: [0] }, text: ['I don\'t want to examine why it was good. I\'m just logging that it was.'] },
  ...
  { when: { stage: [6] }, text: ['It was a dessert thing I\'d been thinking about ordering for three weeks. I ate it. I went on tilt and ate through the whole session and won three games in a row.'] },
  { when: { stage: [7] }, text: ['I went from bronze to silver in one sitting. The correlation is clear and I am choosing to ignore it.'] },
...
{ when: { stage: [5], corruption: [0] }, text: ['I whispered into a microphone and chewed slowly and three hundred people watched in the first hour and left comments that made me sit very quietly afterward. They said this helped them sleep.'] },
  ...
  { when: { stage: [7] }, text: ['The algorithm found the channel. New viewers arrive daily now — people who don\'t know the community, who found the video through a recommendation. They become part of the community.'] },
  { when: { stage: [8] }, text: ['A creator I watch included me in a \'recommended channels\' post. The message was generous and accurate. Her audience came over and many of them stayed.'] },
...
{ when: { stage: [5], corruption: [0] }, text: ['I felt responsible in a way that\'s unfamiliar and good.'] },
  ...
  { when: { stage: [7] }, text: ['The community is patient with newcomers. I\'m proud of that.'] },
  { when: { stage: [8] }, text: ['The comment section is larger now but the care in it has not diminished.'] },
...
{ when: { stage: [5], corruption: [0] }, text: ['The character started as someone else. She\'s a literature major who gains weight — slowly, without apology — and the people around her find it beautiful and bring her food.'] },
  ...
  { when: { stage: [7] }, text: ['" I didn\'t turn around. "It\'s very good," she said. " I went home and wrote four thousand words that night. The character based on her gains ten pounds in the new chapter.'] },
...
{ when: { stage: [5], corruption: [0] }, text: ['Made sweet potato pie from scratch at two in the morning because I couldn\'t sleep and the kitchen was there. I ate half of it warm, standing in front of the oven.'] },
  ...
  { when: { stage: [8] }, text: ['Mae calls every Sunday at 10am. I always eat while we talk — something I made, something I\'m testing, something I\'m just hungry for. She never comments on the eating. She asks what I made.'] },
  { when: { stage: [9] }, text: ['\' She is right. I take up most of it already — me and my jars and my cast iron and the folding table I\'ve turned into a homestead and the smell of whatever I made last night still in the air.'] },
...
{ when: { stage: [5], corruption: [0] }, text: ['By the time I finished writing down what I\'d used I was full in a way that felt right. I wrote the number on the scale in the recipe book this morning.'] },
  ...
  { when: { stage: [7] }, text: ['I am one of them. I have always been one of them.'] },
  { when: { stage: [8] }, text: ['She asks how it turned out. She asks if I\'m happy. I always say yes and I always mean it.'] },
...
{ when: { stage: [5], corruption: [0] }, text: ['First county fair entry. Darcy from Meadowview looked at me like I wasn\'t serious. She won. I drove home knowing exactly what I did wrong and exactly what I\'m going to do next.'] },
  ...
  { when: { stage: [7] }, text: ['State qualifier. I crossed Darcy on the scoreboard for the first time. She stopped eating mid-bite.'] },
  { when: { stage: [8] }, text: ['State finals. I won.'] },
...
{ when: { stage: [5], corruption: [0] }, text: ['I wrote both things down. The number I ate during the event is also in the notes.'] },
  ...
  { when: { stage: [8] }, text: ['Darcy started clapping — full hand-claps, not the polite kind, the kind that means she\'s genuinely applauding — and she kept going for a long time after everyone else in the tent had finished.'] },
...
export function renderDiary(student, week) {
  ...
  const ctx = createContext({ subject: student, week: week || 1, globals: gatewaySelectorGlobals(student) });
  ...
  // studentId / stage / corruption / the signature gateway flags, with a
  // generic fallback so it covers every non-evolved student. (The old base
