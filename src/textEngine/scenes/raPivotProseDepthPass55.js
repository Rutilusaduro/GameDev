...
registerPool('talk.check_in', [
  { when: {}, weight: 2, text: [`She sets her phone face-down when you enter — a small courtesy that feels like trust.`, `{subject.name} asks how the hall is doing before she asks how she is doing. You notice.`, `"Busy week," she says, and pats the chair like she saved it.`] },
]);
...
registerPool('talk.suggest_indulgence.b00', [
  { when: {}, weight: 1, text: [`The moment stretches — unhurried, intimate, hall-quiet.`, `{subject.name} meets your eyes like the rest of the floor can wait.`, `Warmth pools in the room the way fullness pools in her.`] },
]);
