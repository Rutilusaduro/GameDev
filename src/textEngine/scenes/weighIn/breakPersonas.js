...
registerModuleVariants("wi.breakLine", [
  ...
  { when: { studentId: 0, corruption: [2] }, weight: W, text: [
    ...
    `"Beautiful," she says of the wreckage, then of herself{wi.breakBellyTouch|prefix:, }. "Same energy."`,
  ]},
  ...
  { when: { studentId: 1, corruption: [2] }, weight: W, text: [
    ...
    `"Publishable," she murmurs{wi.breakBellyTouch|prefix:, }. "All of it."`,
  ]},
  ...
  { when: { studentId: 2, corruption: [2] }, weight: W, text: [
    `Kylie pans from the cracked dial to herself{wi.breakBellyTouch|prefix:, }. "Watch me break the next one too."`,
  ...
  { when: { studentId: 3, corruption: [2] }, weight: W, text: [
    `"Champion," Serena murmurs{wi.breakBellyTouch|prefix:, }, satisfied. "Get a scale that can keep up with me."`,
  ...
  { when: { studentId: 4, corruption: [2] }, weight: W, text: [
    `"Masterpiece in progress," Fiona whispers{wi.breakBellyTouch|prefix:, }. "Needs a bigger gallery. And a bigger scale."`,
  ...
  { when: { studentId: 5, corruption: [2] }, weight: W, text: [
    `"Endgame body," Destiny murmurs{wi.breakBellyTouch|prefix:, }. "Server couldn't handle the patch. GG."`,
  ...
  { when: { studentId: 6, corruption: [2] }, weight: W, text: [
    `"More is more, babe," Tiffany says{wi.breakBellyTouch|prefix:, }, radiant. "Get a bigger one. I'll break that too."`,
  ...
  { when: { studentId: 7, corruption: [2] }, weight: W, text: [
    `"Maximum output," Priya says with executive calm{wi.breakBellyTouch|prefix:, }. "Current instrumentation insufficient."`,
  ...
  { when: { studentId: 8, corruption: [2] }, weight: W, text: [
    `"More," Maya says, meeting your eyes{wi.breakBellyTouch|prefix:, }. One word. She means the scale, and herself.`,
  ...
  { when: { studentId: 9, corruption: [2] }, weight: W, text: [
    `"Tell my mam I died happy," Chloe laughs{wi.breakBellyTouch|prefix:, }. "And enormous. And the scale knew it."`,
  ...
  { when: { studentId: 10, corruption: [2] }, weight: W, text: [
    `"Second helping," Reneé murmurs{wi.breakBellyTouch|prefix:, }, radiant and round. "Of everything. Scale included."`,
  ...
  { when: { studentId: 11, corruption: [2] }, weight: W, text: [
    `"Plenty of room," Kaylee says warmly{wi.breakBellyTouch|prefix:, }. "For me. Get a bigger scale."`,
  ...
  { when: { studentId: 12, corruption: [2] }, weight: W, text: [
    `"You wanted this demonstrated," Nadia says, watching you watch her{wi.breakBellyTouch|prefix:, }. "There. Demonstrated."`,
    `"Integration complete," she says, hands on her soft belly. "The scale failed to integrate."`,
  ]},
  ...
  { when: { studentId: 13, corruption: [2] }, weight: W, text: [
    `"Come eat," Daisy murmurs{wi.breakBellyTouch|prefix:, }, glowing. "And get a bigger scale while you're at it."`,
  ...
  { when: { studentId: 14, corruption: [2] }, weight: W, text: [
    `"Bounty," Mary Jane says simply{wi.breakBellyTouch|prefix:, }. "Scale couldn't hold it. Get a barn-sized one."`,
  ...
  { when: { studentId: 15, corruption: [2] }, weight: W, text: [
    `Lilith smiles down at the wreckage. "It saw what was coming. It still broke."`,
  ...
  { when: { studentId: 16, corruption: [2] }, weight: W, text: [
    ...
    `"Collateral damage," she says{wi.breakBellyTouch|prefix:, }. "Acceptable. The trial continues."`,
  ...
  { when: { studentId: 17, corruption: [2] }, weight: W, text: [
    `Indiana Bones grins at the wreckage{wi.breakBellyTouch|prefix:, }. "Fortune and glory," she says. "Mostly stored locally now."`,
