...
export const BODY_WORDS = {
  ...
  rotund: {
    thin:    ["a trim frame with a hint of roundness"],
    soft:    ["a soft, doughy middle starting to show", "a figure rounding out evenly"],
    plush:   ["a plump, rotund shape from every angle", "a body gone soft and spherical"],
    heavy:   ["a heavy, round body that rolls when she moves", "a gut and hips grown into one continuous curve"],
    massive: ["a vast, ballooning roundness", "a body that has become mostly belly and soft flank"],
    giant:   ["a colossal round mass, shape remembered only as a circle"],
  },
  voluptuous: {
    thin:    ["curves already present, even when slim"],
    soft:    ["breasts and hips deepening together", "a voluptuous figure quietly swelling"],
    plush:   ["heavy breasts and wide hips grown plush", "curves stacked and straining at every seam"],
    heavy:   ["enormous breasts resting on a soft belly", "a voluptuous body that fills every chair"],
    massive: ["breasts and belly grown past any ordinary scale", "curves so heavy they lead every movement"],
    giant:   ["voluptuous excess become immobile abundance"],
  },
  mom_bod: {
    thin:    ["a practical, straight figure with room to soften"],
    soft:    ["a gentle mom-soft middle settling in", "hips and waist going comfortably lived-in"],
    plush:   ["a soft mom-bod spread, warm at the middle", "a nurturing thickness around waist and hip"],
    heavy:   ["a heavy, maternal softness from chest to thigh", "a body built for comfort and second helpings"],
    massive: ["a vast, pillowy mom-bod that dominates the couch", "soft abundance in every familiar place"],
    giant:   ["maternal softness scaled up past any couch"],
  },
  fertility_goddess: {
    thin:    ["wide hips on a still-slender frame"],
    soft:    ["breasts and hips ripening together", "a fertile curve starting to show"],
    plush:   ["heavy breasts and thunder thighs grown plush", "a goddess-soft body swelling with abundance"],
    heavy:   ["breasts and hips grown heavy and commanding", "a fertile, overflowing figure"],
    massive: ["breasts, belly, and hips grown mythic in scale"],
    giant:   ["fertility made flesh, immobile and vast"],
  },
  topHeavy: {
    thin:    ["a narrow lower half under a fuller chest"],
    soft:    ["breasts growing ahead of everything else", "a top-heavy softness settling in"],
    plush:   ["heavy breasts leading a still-narrower lower half", "a chest grown plush while hips play catch-up"],
    heavy:   ["enormous breasts resting on a softer middle", "a top-heavy body that tips forward when she leans"],
    massive: ["breasts so heavy they dominate her silhouette"],
    giant:   ["a vast upper body that has outgrown the rest"],
  },
  default: {
    thin:    ["a slim figure"],
