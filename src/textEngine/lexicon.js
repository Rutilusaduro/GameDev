...
export const SIZE_WORDS = {
  slight:   ["slight", "angular", "underweight", "wispy", "bird-boned", "narrow through the hips", "barely there", "all collarbone and edges", "light enough to miss", "sparrow-light"],
  slim:     ["slim", "slender", "lean", "narrow", "willowy", "light on her feet", "trim", "neat-waisted", "spare", "quick and unencumbered"],
  soft:     ["soft", "softened", "rounded", "filled-out", "gently padded", "yielding at the edges", "taking on curves", "newly plush at the hip", "warm under the hand", "sweetly cushioned"],
  chubby:   ["chubby", "thickening", "padded", "rounded", "pleasantly plump", "soft in the middle", "noticeably fuller", "ripening", "generous at the waist", "cushioned everywhere it counts"],
  plump:    ["plump", "thick", "heavyset", "well-padded", "substantially soft", "carrying extra weight", "full-figured", "lush", "richly rounded", "deep-cushioned"],
  heavy:    ["heavy", "broad", "ponderous", "weighty", "substantial", "dense with softness", "carrying real mass", "lavishly heavy", "slow and abundant", "thick through every line"],
  fat:      ["fat", "very fat", "rolling", "waddling", "abundant", "overflowing at the seams", "generously proportioned", "gloriously wide", "soft past every seam", "heavy enough to announce herself"],
  veryFat:  ["very fat", "vast", "immense", "overflowing", "enormous", "barely contained", "spilling past every edge", "wider than the furniture allows", "sumptuously massive", "a slow tide of softness"],
  enormous: ["enormous", "staggering", "room-filling", "mountainous", "colossal in scale", "immense by any measure", "overwhelmingly large", "vast enough to change how rooms are used", "a soft enormity", "heavy past all reckoning"],
  colossal: ["monumental", "barely mobile", "overwhelming", "spreadingly vast", "architectural in scale", "immobile with mass", "beyond ordinary furniture", "a warm monument of flesh", "vast enough to plan around", "heavy the way buildings are heavy"],
  blob:     ["immobile", "mountainous", "room-filling", "warmly spreading", "a landscape of flesh", "settled into sheer bulk", "motionless abundance", "a soft continent", "spread wide and deeply content", "an expanse the eye travels rather than takes in"],
  leviathan: ["impossibly vast", "overwhelming", "warm and endless", "barely mobile", "a weather system of softness", "beyond measurement", "the room bends around her", "a horizon of warm flesh", "vast past the vocabulary for it", "endless in every direction that matters"],
};
...
export const BODY_WORDS = {
  pear: bodyRow(
    ...
    ["slender hips flaring gently from a narrow waist", "a slim lower curve just starting to show", "a hint of flare below a small waist"],
  ...
  apple: bodyRow(
    ...
    ["a slender middle with a gentle forward suggestion", "a trim torso, apple shape structurally present", "a flat belly with the first soft promise of forward roundness"],
    ...
    ["a belly extending far in front of her", "a gut vast enough to be the primary fact of the room", "a forward expanse that settles long after she does"],
  ...
  hourglass: bodyRow(
    ...
    ["a neat hourglass on a slender frame", "waist nipping in cleanly from gentle curves", "a light figure with the mold of curves already set"],
    ...
    ["curves stacked on curves, all of them enormous", "an hourglass shape overwhelming in every dimension", "bust and hips vast enough to make the waist between them a rumor"],
    ["curves grown impossibly vast", "bust, belly, and hips a continuous landscape", "an hourglass poured out to fill whatever space allows"],
  ...
  athletic: bodyRow(
    ...
    ["a lean athletic build", "muscle definition clear through a slim frame", "a runner's economy in every line of her"],
    ...
    ["strength entombed in immensity", "a vast athletic frame barely mobile", "broad shoulders holding up an avalanche of softness"],
  ...
  straight: bodyRow(
    ...
    ["a straight slender figure", "even thickness still minimal", "a clean vertical line with nowhere soft yet"],
    ...
    ["uniform enormity from shoulder to knee", "a body round and vast in every measurement", "soft mass distributed with democratic thoroughness"],
  ...
  rotund: bodyRow(
    ...
    ["a slender frame rounding evenly", "gentle spherical tendency showing", "a light body already dreaming in curves"],
    ...
    ["a vast, ballooning roundness", "a body that has become mostly belly and soft flank", "a circumference that keeps surprising doorframes"],
    ["overwhelming roundness", "a spherical abundance of soft flesh", "roundness at a scale furniture takes personally"],
    ["a vast round mass, shape remembered only as a circle", "rotund immensity filling the room", "a warm sphere of flesh the room arranges itself around"],
  ),
  voluptuous: bodyRow(
    ["curves already present, even when slim", "a voluptuous line on a slight frame", "breasts and hips hinted even now"],
    ["curves present on a slender frame", "a voluptuous figure still mobile and light", "a soft silhouette that promises more than it weighs"],
    ...
    ["breasts and belly grown past any ordinary scale", "curves so heavy they dominate her silhouette", "a body that sways in three directions with every step"],
    ["voluptuous excess at staggering scale", "breasts, belly, and hips all enormous", "curves so deep a hand could get lost in any of them"],
    ["voluptuous abundance grown overwhelming", "curves beyond ordinary description", "softness stacked in tiers, every one of them heavy"],
    ["voluptuous excess become immobile abundance", "curves merged into warm immobile mass", "a landscape of bust and hip settled into permanence"],
  ),
  mom_bod: bodyRow(
    ...
    ["a slim practical figure", "a straight build with room to grow comfortable", "a light frame that hugs like it's already softer"],
    ...
    ["a pillowy mom-bod dominating furniture", "maternal softness scaled up past ordinary chairs", "a lap wide enough to be its own seating"],
    ["a vast, pillowy mom-bod that dominates the couch", "soft abundance in every familiar place", "warmth broad enough that hugs disappear into it"],
    ["maternal softness grown overwhelming", "a mom-bod that fills and overflows seating", "comfort scaled up until the couch is a formality"],
  ...
  fertility_goddess: bodyRow(
    ...
    ["wide hips on a slim frame", "breasts and hips ripening subtly", "a slender body built around generous intentions"],
    ...
    ["breasts, belly, and hips grown impossibly vast", "a fertile body needing wide doorways", "ripeness carried in every heavy, swaying line"],
    ["fertility made flesh at enormous scale", "breasts and hips grown staggering", "abundance so complete it reads as intention"],
    ["a fertile body grown overwhelming", "abundance beyond ordinary measure", "a harvest of a body, heavy in every particular"],
    ["fertility made flesh, immobile and vast", "goddess curves become permanent warmth", "abundance settled into a wide, unmoving throne of itself"],
  ),
  topHeavy: bodyRow(
    ...
    ["breasts so heavy they dominate her silhouette", "a vast upper body outgrowing everything below", "a chest that arrives, settles, and keeps settling"],
    ["an enormous chest on an enormous body", "top-heavy excess at staggering scale", "an upper half that needs both arms and planning"],
    ["a vast upper body", "breasts and belly heavy above narrower hips", "a silhouette that leans forward on sheer chest alone"],
    ["a vast upper body that has outgrown the rest", "chest merged into immobile abundance", "top-heavy warmth settled into permanent, pillowy fact"],
  ),
  default: bodyRow(
    ["a slim figure", "a slight angular frame", "a narrow body"],
    ["a slender figure", "a lean easy frame", "a light, unhurried build"],
    ["a figure going gently soft", "softness settling evenly", "new plushness arriving quietly all over"],
    ["a chubby, rounded figure", "clothes fitting noticeably tighter", "a body rounding out with cheerful thoroughness"],
    ["a thick, well-fed figure", "a plump body grown unmistakable", "soft weight worn like a favorite sweater"],
    ["a heavy, abundant body", "weight carried with a slower gait", "heaviness that announces itself before she speaks"],
    ["a fat, soft body", "abundance in every direction", "a body that sways, settles, and keeps settling"],
    ["a very fat, vast body", "mass needing space and care", "softness at a scale that rewrites her routines"],
    ["a body of staggering size", "enormity in every measurement", "mass the eye has to travel to take in"],
    ["an overwhelming body", "size beyond ordinary furniture", "a scale the room accommodates rather than contains"],
...
export const MOVEMENT_WORDS = {
  slight:   ["strides", "moves lightly", "slips along", "takes quick easy steps", "crosses the room without effort", "drifts through space", "darts where she means to go", "moves like she weighs nothing at all"],
  slim:     ["walks easily", "moves with natural ease", "glides through the room", "steps without hurry", "moves like she still owns the floor", "crosses the room in a handful of light steps", "turns on a heel without thinking about it"],
  soft:     ["walks with a new sway", "moves with a soft bounce", "steps with a gentle heaviness settling in", "carries a little more rhythm in her hips", "sways when she turns", "moves with a plushness that wasn't there last month", "keeps swaying a beat after she stops"],
  chubby:   ["walks with a thickened gait", "moves with a soft bounce", "sways slightly with new weight", "steps with thighs beginning to brush", "rocks a little with each stride", "moves with a jiggle she hasn't learned to hide", "settles into each step a little deeper"],
  plump:    ["sways", "moves with deliberate, rolling steps", "walks with thighs brushing together", "carries her weight with a settled rhythm", "moves like the room should make room", "arrives with a soft bounce that outlasts the step", "rolls her hips through every doorway"],
  heavy:    ["waddles slightly", "moves with slow, weighty purpose", "rocks side to side as she goes", "advances with audible breath", "shifts her mass before each step", "moves in a slow, plush rhythm all her own", "leads with her belly and lets the rest follow"],
  fat:      ["waddles", "moves with a rolling gait", "rocks side to side with each deliberate step", "labors pleasantly forward", "lets momentum do half the work", "sways wide enough to need the whole aisle", "moves like a slow warm swell"],
  veryFat:  ["waddles slowly", "moves with great deliberation", "advances one careful step at a time", "pauses to settle between steps", "rolls forward by inches", "plots each step like a small journey", "moves with the patience her body now requires"],
  enormous: ["lumbers", "advances like weather", "moves one ponderous step at a time", "crosses space in slow surges", "makes the floor answer", "arrives the way a tide arrives", "gathers herself before each slow surge forward"],
  colossal: ["shuffles", "moves inches at a time", "shifts her mass with audible effort", "barely crosses the threshold", "repositions rather than walks", "moves in slow negotiated stages", "leans, gathers, and gains a foot of ground"],
  blob:     ["barely moves", "shifts like a slow tide", "settles rather than walks", "ripples when she tries", "exists in place with effort", "redistributes rather than travels", "sways in place like something moored"],
  leviathan: ["barely shifts", "settles rather than walks", "exists more than arrives", "moves like geography rearranging", "arrives by accumulation not stride", "shifts, and the room shifts with her", "settles deeper instead of going anywhere"],
};
...
export const CLOTHING_FIT = {
  ...
  summer: seasonRow(
    ...
    ["summer clothes in name only — straps, panels, and surrender", "fabric that lost every negotiation", "a wrap that covers what it can and blesses the rest"],
...
export const FULLNESS_WORDS = [
  { max: 0.25, words: ["barely touched", "comfortably empty", "light", "hardly started", "still hungry", "room for much more", "hollow with appetite", "empty enough to be impatient about it", "running on appetite alone"] },
  { max: 0.60, words: ["pleasantly full", "satisfied", "warm and fed", "comfortably fed", "content but not done", "softly full", "fed enough to relax", "warm through the middle", "settled and still curious about seconds"] },
  { max: 0.90, words: ["very full", "heavily laden", "packed tight", "substantially full", "stuffed but still moving", "full to the brim", "swollen with food", "heavy with the whole meal", "full enough to sit back and breathe slow"] },
  { max: 1.10, words: ["stuffed to her limit", "achingly full", "stretched taut", "drum-tight", "painfully full", "packed past comfort", "breathing around fullness", "full to the last careful inch", "taut and radiating heat"] },
  { max: Infinity, words: ["overfilled past anything reasonable", "swollen drum-tight", "beyond capacity and still holding", "packed past what should fit", "obscenely full", "stuffed into immobility", "full past the point of pride", "stretched past every previous record", "so full the room seems to hold its breath with her"] },
];
...
export const SIZE_WORDS_SHADED = {
  ...
  1: { // conflicted — stopped arguing with it, not yet celebrating it
    soft:     ["softer, and quietly aware of it", "rounder, and done pretending otherwise"],
    chubby:   ["fuller in a way she's stopped explaining", "padded, and letting the word sit"],
    plump:    ["plump, a fact she's made peace with", "heavier, and strangely calm about it"],
    heavy:    ["heavy in a way she's learning to live inside", "weighty, and no longer apologizing for it"],
    fat:      ["fat, a word she's tried on in private", "large in a way she's stopped negotiating"],
    veryFat:  ["vast, and past the point of arguing", "immense, and oddly settled about it"],
    enormous: ["enormous, a fact she carries without comment", "huge in a way she's quietly absorbed"],
    colossal: ["a scale she's stopped measuring against anything", "vast, and done keeping count"],
    blob:     ["an abundance she's grown fluent in", "mass she's learned to inhabit"],
    leviathan: ["a magnitude she's made her home", "endless, and at ease with it"],
  },
