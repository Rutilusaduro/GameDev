...
export const GROWTH_LEXICON_CHUNKS = [
  // ── APPLE / MIDSECTION (belly) ──
  {
    ...
    texts: [
      ...
      "{subject.first}'s belly answered the surge the way a tide answers the moon — slow, then suddenly everywhere at once.",
      "A warm new apron of weight poured over {subject.name}'s waistband and kept arriving after she thought it had stopped.",
  ...
  // ── PEAR / LOWER BODY ──
  {
    ...
    texts: [
      ...
      "{subject.name}'s hips claimed another inch of doorway while her thighs learned a new, warmer friction.",
      "Weight poured into {subject.first}'s seat and stayed there, a slow heavy yes she could feel through the chair.",
    ],
  },
  // ── HOURGLASS (curves) ──
  {
    ...
    texts: [
      ...
      "{subject.first}'s waist held the memory of a cinch while bust and hip poured past it, a mold overflowing in both directions.",
      "She swelled top and bottom at once, the new weight arriving like two arguments that refused to take turns.",
