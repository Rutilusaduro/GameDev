...
registerPool('word.adv.pace', [
  ...
  { when: { corruption: [1] }, weight: 2,
    consumes: ['psych_mood', 'speed_mod'],
    text: ['with the carefulness of someone still deciding what this means', 'in measured steps', 'without the old flinch'] },
  { when: { gainStance: 'secret', corruption: [0] }, weight: 2,
    text: ['with private focus', 'like someone keeping a pleasant secret'] },
  { when: { gainStance: 'opposed', corruption: [0], stageMin: 2 }, weight: 2,
    text: ['as if speed would make it real', 'with a tightness she calls posture'] },
  { when: { relationship: [2, 3] },
    text: ['toward you', 'like the room already includes you'] },
