...
import { DIVINE_SKILL_TREE } from '../gameData/skills.js';
import { getStage } from '../gameData/stages.js';
import { CLASS_SCENES } from '../gameData/classEvents.js';

// Mortal classroom upgrades were retired; only divine skills remain spendable.
export const ALL_SKILLS = [...DIVINE_SKILL_TREE];
