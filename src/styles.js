...
export const C={
  ...
  overlay:{position:"fixed",top:0,left:0,right:0,bottom:0,background:"rgba(2,0,6,0.9)",backdropFilter:"saturate(1.05) blur(8px)",WebkitBackdropFilter:"saturate(1.05) blur(8px)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:4000},
