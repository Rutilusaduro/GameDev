...
export const C={
  ...
  overlay:{position:"fixed",top:0,left:0,right:0,bottom:0,background:"rgba(3,1,8,0.78)",backdropFilter:"saturate(1.08) blur(7px)",WebkitBackdropFilter:"saturate(1.08) blur(7px)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:300},
