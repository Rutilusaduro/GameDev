...
| Smoke + e2e | ✅ | `npm run test:smoke` — 96/96 e2e, completion-audit 211/211 |
...
| `scripts/test-completion-audit.mjs` | 211 requirement gates |
...
| Steam-quality feel | ⚠️ | 96+ e2e; floor-checkin stagger, Next Week pulse, natural wk8 unlock |
