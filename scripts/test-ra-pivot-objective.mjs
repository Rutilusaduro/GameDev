...
execSync('node scripts/test-wl-talk-depth-retired.mjs', { cwd: root, stdio: 'inherit' });

execSync('node scripts/test-wl-index-bridge-retired.mjs', { cwd: root, stdio: 'inherit' });
...
execSync('node scripts/test-device-modular-late.mjs', { cwd: root, stdio: 'inherit' });
execSync('node scripts/test-talk-encourage-modular-late.mjs', { cwd: root, stdio: 'inherit' });
execSync('node scripts/test-stream-end-modular-late.mjs', { cwd: root, stdio: 'inherit' });
...
execSync('node scripts/test-evolution-ui-stub-debt.mjs', { cwd: root, stdio: 'inherit' });

execSync('node scripts/test-evolution-blurb-modular-late.mjs', { cwd: root, stdio: 'inherit' });

execSync('node scripts/test-salon-gallery-evolved-stub-debt.mjs', { cwd: root, stdio: 'inherit' });
