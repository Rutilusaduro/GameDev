...
assert.ok(hollow >= 41, `expected >=41 hollow pass files, got ${hollow}`);
assert.ok(withVariants <= 66, `pass files with variants should shrink over time, got ${withVariants}`);
