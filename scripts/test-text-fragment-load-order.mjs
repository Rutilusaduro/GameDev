...
const pairs = [
  ...
  ['origin/index.js', 'origin/originResidentModularFragments.js'],
  ['roomVisit/index.js', 'roomVisit/roomVisitModularFragments.js'],
  ['feedForce/index.js', 'feedForce/feedForceModularFragments.js'],
  ['corruptionTierUp/index.js', 'corruptionTierUp/corruptionTierUpModularFragments.js'],
  ['intimacy/index.js', 'intimacy/intimacyModularFragments.js'],
  ['weeklyEvent/weeklyEventLateModularFragments.js', 'raPivotLateSlotReinforcementFragments.js'],
